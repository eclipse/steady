...
public class AsymmetricBindingHandler extends AbstractBindingBuilder {
  ...
  public AsymmetricBindingHandler(
      WSSConfig config,
    ...
    if (abinding.isSignatureProtection()) {
      ...
      if (encryptionToken.isDerivedKeys()
        ...
        try {
          ...
          Element secondRefList =
              saaj.getSOAPPart()
                  .createElementNS(WSConstants.ENC_NS, WSConstants.ENC_PREFIX + ":ReferenceList");
  ...
  private WSSecBase doEncryption(
      TokenWrapper recToken, List<WSEncryptionPart> encrParts, boolean externalRef) {
    // Do encryption
