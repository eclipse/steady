...
public class SamlTokenPolicyValidator extends AbstractSamlPolicyValidator
  ...
  /**
   * Check the IssuerName policy against the received assertion private boolean
   * checkIssuerName(SamlToken samlToken, AssertionWrapper assertionWrapper) { String issuerName =
   * samlToken.getIssuerName(); if (issuerName != null && !"".equals(issuerName)) { String
   * assertionIssuer = assertionWrapper.getIssuerString(); if (!issuerName.equals(assertionIssuer))
