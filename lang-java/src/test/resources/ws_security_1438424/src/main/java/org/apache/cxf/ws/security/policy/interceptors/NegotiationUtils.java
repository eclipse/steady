...
/**
 * This is a collection of utility methods for use in negotiation exchanges such as
 * WS-SecureConversation and WS-Trust for SPNEGO.
 */
final class NegotiationUtils {
  ...
  static void recalcEffectivePolicy(
      SoapMessage message, String namespace, Policy policy, Invoker invoker, boolean secConv) {
  ...
  static CallbackHandler getCallbackHandler(Object o, Class<?> clazz) {
    ...
    if (o instanceof CallbackHandler) {
      ...
      try {
        handler = (CallbackHandler) ClassLoaderUtils.loadClass((String) o, clazz).newInstance();
      } catch (Exception e) {
        handler = null;
      }
    }
