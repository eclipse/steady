...
public class CryptoCoverageCheckerTest extends AbstractSecurityTest {
  ...
  public void testOrder() throws Exception {
    ...
    assertTrue(
        output.contains(
            "MustUnderstandInterceptor, SAAJInInterceptor, "
  ...
  public void testSignedWithIncompleteCoverage() throws Exception {
    ...
    this.runInterceptorAndValidate(
        "signed_x509_issuer_serial_missing_signed_header.xml", null, null, true);
  }
  ...
  public void testEncryptedWithIncompleteCoverage() throws Exception {
    this.runInterceptorAndValidate(
        ...
        this.getPrefixes(),
        Arrays.asList(
            new XPathExpression("//ser:Header", CoverageType.ENCRYPTED, CoverageScope.ELEMENT)),
        false);
    ...
    this.runInterceptorAndValidate(
        ...
        this.getPrefixes(),
        Arrays.asList(
            new XPathExpression("//soap:Body", CoverageType.ENCRYPTED, CoverageScope.ELEMENT)),
        false);
