...
public class STSClientTest extends Assert {
  ...
  public void testConfigureViaEPR() throws Exception {
    ...
    JAXBContext ctx =
        JAXBContextCache.getCachedContextAndSchemas(addressingClasses, null, null, null, true)
            .getContext();
    ...
    assertEquals(
        "http://localhost:8080/jaxws-samples-wsse-policy-trust-sts/SecurityTokenService?wsdl",
    ...
    assertEquals(
        new QName("http://docs.oasis-open.org/ws-sx/ws-trust/200512/", "UT_Port"),
