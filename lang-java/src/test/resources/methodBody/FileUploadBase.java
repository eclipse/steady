 ...
 *
 * @version $Id: FileUploadBase.java 1565143 2014-02-06 10:14:24Z markt $
 */
public abstract class FileUploadBase {
   ...
   *
   * <p><strong>NOTE:</strong>This method will be moved to the <code>ServletFileUpload</code> class
   ...
   *
   * @deprecated This constant is no longer used. As of commons-fileupload 1.2, the only applicable
   *     limit is the total size of a parts headers, {@link MultipartStream#HEADER_PART_SIZE_MAX}.
   */
      ...
      while (iter.hasNext()) {
        ...
        try {
          ...
          throw new IOFileUploadException(
              format("Processing of %s request failed. %s", MULTIPART_FORM_DATA, e.getMessage()),
              e);
        }
  ...
  /**
   * Thrown to indicate that the request size is not specified. In other words, it is thrown, if the
   * content-length header is missing or contains the value -1.
   *
