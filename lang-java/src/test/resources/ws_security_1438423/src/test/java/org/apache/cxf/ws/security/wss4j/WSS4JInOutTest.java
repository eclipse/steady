...
public class WSS4JInOutTest extends AbstractSecurityTest {
  ...
  /**
   * @return a processor map suitable for custom processing of signatures (in this case, the actual
   *     processor is null, which will cause the WSS4J runtime to do no processing on the input)
   */
  private Map<QName, String> createCustomProcessorMap() {
    final Map<QName, String> ret = new HashMap<QName, String>();
    ret.put(new QName(WSConstants.SIG_NS, WSConstants.SIG_LN), null);
    return ret;
  }
