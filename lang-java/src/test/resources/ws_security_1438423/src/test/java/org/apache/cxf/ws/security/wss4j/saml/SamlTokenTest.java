...
public class SamlTokenTest extends AbstractSecurityTest {
  ...
  public void testSaml1Token() throws Exception {
    ...
    WSSecurityEngineResult actionResult =
        WSSecurityUtil.fetchActionResult(
            handlerResults.get(0).getResults(), WSConstants.ST_UNSIGNED);
  ...
  /**
   * This test creates a holder-of-key SAML1 Assertion, and sends it in the security header to the
   * provider.
   */
  @Test
  ...
  /**
   * This test creates a holder-of-key SAML2 Assertion, and sends it in the security header to the
   * provider.
   */
  @Test
  ...
  /**
   * This test creates a SAML2 Assertion and sends it in the security header to the provider. An
   * single attribute is created for the roles but multiple attribute value elements.
   */
  @Test
  ...
  /**
   * This test creates a SAML2 Assertion and sends it in the security header to the provider. An
   * attribute is created per role. There are several attributes with the same name.
   */
  @Test
