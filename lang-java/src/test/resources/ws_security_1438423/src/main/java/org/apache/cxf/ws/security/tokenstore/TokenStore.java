...
/**
 * This interface defines a caching mechanism for security tokens. It is up to the underlying
 * implementation to handle token expiration (e.g. by querying the SecurityToken's expires date).
 */
public interface TokenStore {

  /**
   * Add the given token to the cache. The SecurityTokens getId() identifier will be used to key it
   * in the cache.
   *
