 ...
 * instance will be supplied with this class, which contains a reference to the current Message. The
 * CallbackHandler implementation is required to set the claims Element to be sent in the request.
 */
