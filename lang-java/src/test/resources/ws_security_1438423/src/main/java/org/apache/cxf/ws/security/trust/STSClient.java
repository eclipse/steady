...
/**
 * A extension of AbstractSTSClient to communicate with an STS and return a SecurityToken to the
 * client.
 */
public class STSClient extends AbstractSTSClient {
  ...
  public SecurityToken requestSecurityToken(String appliesTo, String binaryExchange)
      throws Exception {
