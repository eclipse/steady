...
public class Callgraph {
  ...
  public Callgraph(final Graph<ConstructId> _g) {
    ...
    while (iter.hasNext()) {
      ...
      final Iterator<ConstructId> succNodes =
          (Iterator<ConstructId>) _g.getSuccNodes((Object) src_node);
  ...
  private Map<String, LinkedList<Integer>> computeShortestPath(
      final String _tgt, Map<String, LinkedList<Integer>> _path) {
    final Iterator<String> predNodes = (Iterator<String>) graph_qname.getPredNodes((Object) _tgt);
    String prednode = null;
  ...
  private Map<String, HashSet<Short>> computeAllEdges(
      final String _tgt, Map<String, HashSet<Short>> _edges) {
    final Iterator<String> predNodes = (Iterator<String>) graph_qname.getPredNodes((Object) _tgt);
    String prednode = null;
  ...
  public HashSet<LinkedList<Short>> assembleAllPaths(
      final String _src, final String _tgt, final Map<String, HashSet<Short>> _alledges) {
  ...
  private HashSet<LinkedList<Short>> assemblePath(
      final String _src,
      final String _tgt,
      final Map<String, HashSet<Short>> _alledges,
      final LinkedList<Short> _path,
      HashSet<LinkedList<Short>> _allpaths) {
    if (_src.equals(_tgt)) {
  ...
  public int oneInOneOut() {
    ...
    for (final String node : graph_qname) {
      if (graph_qname.getPredNodeCount((Object) node) == 1
          && graph_qname.getSuccNodeCount((Object) node) == 1) {
        ++n;
      }
    }
    return n;
