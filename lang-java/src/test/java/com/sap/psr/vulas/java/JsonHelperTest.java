...
public class JsonHelperTest {
  ...
  /**
   * Analyzes a JAR that contains nested classes (having a $ in their name), but not the surrounding
   * class. In fact, a $ is a permitted character in class names. It is only a convention to not use
   * it.
   */
  @Test
