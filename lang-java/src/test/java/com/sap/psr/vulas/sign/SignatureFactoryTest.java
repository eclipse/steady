...
public class SignatureFactoryTest {
    ...
    public void createSignature() throws Exception {
    	...
    	final ASTConstructBodySignature s = (ASTConstructBodySignature) f.createSignature(new ConstructId(ProgrammingLanguage.JAVA, ConstructType.METH, "org.foo.Filter.doFilter(Boolean,String,String)"), new File("./src/test/resources/Filter.java"));
