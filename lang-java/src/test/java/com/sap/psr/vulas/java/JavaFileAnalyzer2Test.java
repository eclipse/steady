...
public class JavaFileAnalyzer2Test {
        ...
        try {
            final JavaFileAnalyzer2 jfa =
                    (JavaFileAnalyzer2)
                            FileAnalyzerFactory.buildFileAnalyzer(
                                    new File(
                                            "./src/test/java/com/sap/psr/vulas/java/test/ConfigurationKey.java"));
        ...
        try {
            ...
            final JavaClassId named_class =
                    JavaId.parseClassQName(
                            "com.sap.psr.vulas.java.test.HttpRequestCompletionLog$Builder");
            ...
            final JavaClassId anon_class =
                    JavaId.parseClassQName(
                            "com.sap.psr.vulas.java.test.HttpRequestCompletionLog$Builder$1");
        ...
        try {
            final JavaFileAnalyzer2 jfa =
                    (JavaFileAnalyzer2)
                            FileAnalyzerFactory.buildFileAnalyzer(
                                    new File(
                                            "./src/test/java/com/sap/psr/vulas/java/test/ConfigKey.java"));
            final Map<ConstructId, Construct> constructs = jfa.getConstructs();
            ...
            final JavaMethodId enum_m3 =
                    JavaId.parseMethodQName(
                            "com.sap.psr.vulas.java.test.ConfigKey.getDefaultValue()");
            final JavaMethodId enum_m4 =
                    JavaId.parseMethodQName(
                            "com.sap.psr.vulas.java.test.ConfigKey.fromKey(String)");
            ...
            final JavaConstructorId nc1_c =
                    JavaId.parseConstructorQName(
                            "com.sap.psr.vulas.java.test.ConfigKey$1InnerClass1()");
            final JavaMethodId nc1_m =
                    JavaId.parseMethodQName(
                            "com.sap.psr.vulas.java.test.ConfigKey$1InnerClass1.foo()");

            final JavaClassId nc2 =
                    JavaId.parseClassQName("com.sap.psr.vulas.java.test.ConfigKey$1InnerClass2");
            final JavaMethodId nc2_m =
                    JavaId.parseMethodQName(
                            "com.sap.psr.vulas.java.test.ConfigKey$1InnerClass2.foo()");
            ...
            final JavaConstructorId nc3_c =
                    JavaId.parseConstructorQName(
                            "com.sap.psr.vulas.java.test.ConfigKey$2InnerClass1()");
            final JavaMethodId nc3_m =
                    JavaId.parseMethodQName(
                            "com.sap.psr.vulas.java.test.ConfigKey$2InnerClass1.foo()");
        ...
        try {
            final JavaFileAnalyzer2 jfa =
                    (JavaFileAnalyzer2)
                            FileAnalyzerFactory.buildFileAnalyzer(
                                    new File(
                                            "./src/test/java/com/sap/psr/vulas/java/test/Vanilla.java"));
            final Map<ConstructId, Construct> constructs = jfa.getConstructs();
    ...
    public void testNestedDeclarationMess() {
        try {
            ...
            final JavaClassId cl1 =
                    JavaId.parseClassQName(
                            "com.sap.psr.vulas.java.test.NestedDeclarations"); // line 5
            final JavaMethodId cl1_m =
                    JavaId.parseMethodQName(
                            "com.sap.psr.vulas.java.test.NestedDeclarations.doSomething()"); // line
            // 42
            ...
            final JavaClassId cl4 =
                    JavaId.parseClassQName(
                            "com.sap.psr.vulas.java.test.NestedDeclarations$1"); // line 26
            ...
            final JavaClassId cl7 =
                    JavaId.parseClassQName(
                            "com.sap.psr.vulas.java.test.NestedDeclarations$2"); // line 45
            ...
            final JavaEnumId e =
                    JavaId.parseEnumQName(
                            "com.sap.psr.vulas.java.test.NestedDeclarations$Foo"); // line 62
            ...
            final JavaClassId cl10 =
                    JavaId.parseClassQName(
                            "com.sap.psr.vulas.java.test.NestedDeclarations$Foo$1DoThis"); // line
            // 66
            ...
            final JavaClassId cl11 =
                    JavaId.parseClassQName(
                            "com.sap.psr.vulas.java.test.NestedDeclarations$Foo$1DoThis$1"); // line
            // 71
        ...
        try {
            final JavaFileAnalyzer2 jfa =
                    (JavaFileAnalyzer2)
                            FileAnalyzerFactory.buildFileAnalyzer(
                                    new File(
                                            "./src/test/java/com/sap/psr/vulas/java/test/Generics.java"));
            final Map<ConstructId, Construct> constructs = jfa.getConstructs();
    ...
    private boolean compareConstructSets(
        ...
        final Set<ConstructId> sourcecode_constructs =
                new HashSet<ConstructId>(_sourcecode_constructs);
        ...
        JavaConstructorId cons =
                JavaId.parseConstructorQName(
                        "com.sap.psr.vulas.java.test.TestAnon$Foo(String,int)");
        JavaMethodId values =
        ...
        if (!bytecode_constructs.isEmpty()) {
            System.out.println(
                    bytecode_constructs.size()
                            + " unmatched constructs in first set (from bytecode):");
        ...
        if (!sourcecode_constructs.isEmpty()) {
            System.out.println(
                    sourcecode_constructs.size()
                            + " unmatched constructs in second set (from source code):");
