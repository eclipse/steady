		...
		public HttpRequestCompletionLog build() {
			...
			return new HttpRequestCompletionLog() {
				...
				public String toString() {
					return "HttpRequestCompletionLog [destination=" + destination + ", targetPath=" + targetPath
							+ ", startTimeInMillis=" + startTimeInMillis + ", durationInMillis=" + durationInMillis
							+ ", requestEntitySizeInBytes=" + requestEntitySizeInBytes + ", responseEntitySizeInBytes="
							+ responseEntitySizeInBytes + ", responseStatus=" + responseStatus
							+ ", responseReasonPhrase=" + responseReasonPhrase + ", responseContentType="
							+ responseContentType + "]";
				}
