...
public class ConstructTransformerTest {
  ...
  /**
   * This method overloads the other method having the same name, which allows testing whether
   * StackTraceUtil can successfully identify the right method based on line numbers.
   *
   * @param _i
   */
