...
public class ASTSignatureComparatorTest {
    ...
    private void setupFixedConstruct() throws FileAnalysisException {
        FileAnalyzer jfa2 =
                FileAnalyzerFactory.buildFileAnalyzer(new File(TEST_DATA + _fixedJavaFile));
    ...
    public void testChangeComparison() throws FileAnalysisException, IOException {
        ...
        final String sig_chg_json =
                FileUtil.readFile(
                        Paths.get(
                                "./src/test/resources/methodBody/deserialize/signatureChange.json"));
        final SignatureChange ddf =
                (ASTSignatureChange)
                        JacksonUtil.asObject(
                                sig_chg_json, custom_deserializers, ASTSignatureChange.class);
        ...
        final Set<Object> i_dt =
                ASTUtil.intersectSourceCodeChanges(
                        ddt.getModifications(), ddf.getModifications(), false);
        final Set<Object> i_tf =
                ASTUtil.intersectSourceCodeChanges(
                        dtf.getModifications(), ddf.getModifications(), false);
    ...
    private static final String vulSigJson =
            "{\"ast\":[ {\"Value\" : \"MultipartStream\",\"SourceCodeEntity\" :{ \"Modifiers\" :"
                ...
                + " \"ASSIGNMENT\"},{\"Value\" : \"this.notifier ="
                + " pNotifier;\",\"SourceCodeEntity\" :{ \"Modifiers\" : \"0\",\"SourceRange\" :"
                + " {\"Start\" : 266,\"End\" : 291}},\"EntityType\" : \"ASSIGNMENT\"},{\"Value\" :"
                + " \"this.boundary = new byte[(boundary.length +"
                + " BOUNDARY_PREFIX.length)];\",\"SourceCodeEntity\" :{ \"Modifiers\" :"
                + " \"0\",\"SourceRange\" : {\"Start\" : 407,\"End\" : 473}},\"EntityType\" :"
                + " \"ASSIGNMENT\"},{\"Value\" : \"this.boundaryLength = (boundary.length +"
                + " BOUNDARY_PREFIX.length);\",\"SourceCodeEntity\" :{ \"Modifiers\" :"
                ...
                + " \"ASSIGNMENT\"},{\"Value\" : \"System.arraycopy(BOUNDARY_PREFIX, 0,"
                + " this.boundary, 0, BOUNDARY_PREFIX.length);\",\"SourceCodeEntity\" :{"
                + " \"Modifiers\" : \"0\",\"SourceRange\" : {\"Start\" : 606,\"End\" :"
                + " 701}},\"EntityType\" : \"METHOD_INVOCATION\"},{\"Value\" :"
                + " \"System.arraycopy(boundary, 0, this.boundary, BOUNDARY_PREFIX.length,"
                + " boundary.length);\",\"SourceCodeEntity\" :{ \"Modifiers\" :"
                ...
                + " 0;\",\"SourceCodeEntity\" :{ \"Modifiers\" : \"0\",\"SourceRange\" :"
                + " {\"Start\" : 846,\"End\" : 854}},\"EntityType\" : \"ASSIGNMENT\"}]}]}";
    private static final String fixSigJson =
            "{\"ast\":[ {\"Value\" : \"MultipartStream\",\"SourceCodeEntity\" :{ \"Modifiers\" :"
                ...
                + " 1))\",\"SourceCodeEntity\" :{ \"Modifiers\" : \"0\",\"SourceRange\" :"
                + " {\"Start\" : 480,\"End\" : 667}},\"EntityType\" : \"IF_STATEMENT\",\"C\" :"
                + " [{\"Value\" : \"(bufSize < (this.boundaryLength + 1))\",\"SourceCodeEntity\""
                + " :{ \"Modifiers\" : \"0\",\"SourceRange\" : {\"Start\" : 519,\"End\" :"
                + " 667}},\"EntityType\" : \"THEN_STATEMENT\",\"C\" : [{\"Value\" : \"new"
                + " IllegalArgumentException(\\\"The buffer size specified for the MultipartStream"
                + " is too small\\\");\",\"SourceCodeEntity\" :{ \"Modifiers\" :"
                + " \"0\",\"SourceRange\" : {\"Start\" : 534,\"End\" : 656}},\"EntityType\" :"
                ...
                + " \"ASSIGNMENT\"},{\"Value\" : \"System.arraycopy(BOUNDARY_PREFIX, 0,"
                + " this.boundary, 0, BOUNDARY_PREFIX.length);\",\"SourceCodeEntity\" :{"
                + " \"Modifiers\" : \"0\",\"SourceRange\" : {\"Start\" : 785,\"End\" :"
                + " 880}},\"EntityType\" : \"METHOD_INVOCATION\"},{\"Value\" :"
                + " \"System.arraycopy(boundary, 0, this.boundary, BOUNDARY_PREFIX.length,"
                + " boundary.length);\",\"SourceCodeEntity\" :{ \"Modifiers\" :"
                ...
                + " 0;\",\"SourceCodeEntity\" :{ \"Modifiers\" : \"0\",\"SourceRange\" :"
                + " {\"Start\" : 1025,\"End\" : 1033}},\"EntityType\" : \"ASSIGNMENT\"}]}]}";
    private static final String sigChange =
            "{\"StructureEntity\" :{ \"UniqueName\" : \"MultipartStream\",\"EntityType\" :"
                ...
                + " IllegalArgumentException(\\\"The buffer size specified for the MultipartStream"
                + " is too small\\\");\",\"EntityType\" : \"THROW_STATEMENT\",\"Modifiers\" :"
                + " \"0\",\"SourceCodeRange\" : {\"Start\" : \"534\",\"End\" :"
                + " \"656\"}},\"ParentEntity\" : {\"UniqueName\" : \"(bufSize <"
                + " (this.boundaryLength + 1))\",\"EntityType\" : \"THEN_STATEMENT\",\"Modifiers\""
                + " : \"0\",\"SourceCodeRange\" : {\"Start\" : \"519\",\"End\" : \"667\"}}}]}}";
    ...
    public void testCompareFromJson() {
        try {
            ...
            final String vul_sig_json =
                    FileUtil.readFile(
                            Paths.get(
                                    "./src/test/resources/methodBody/deserialize/signatureDef.json"));
            final String fix_sig_json =
                    FileUtil.readFile(
                            Paths.get(
                                    "./src/test/resources/methodBody/deserialize/signatureFix.json"));
