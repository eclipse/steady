...
public class ASTSignatureComparatorTest {
  ...
  public void testSignComparatorContainsChange2() throws FileAnalysisException {
    ...
    */
    /**
     * LAZY SOLUTION : The call in class ASTSignatureChange :getModifications(){
     * mDistiller.extractClassifiedSourceCodeChanges(defSignatureNode, fixSignatureNode);} Changes
     * the defective version into the fixed one, (No pass by Reference), Until I find a better
     * solution, compute Signature of the defective construct again
     */
    /*
    this.setupDefectiveConstruct();
