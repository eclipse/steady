...
public class JarWriterTest implements JarEntryWriter {
    ...
    public void testRewrite() {
        try {
            ...
            // Create a new JarWriter and check whether is recognized as rewritten (the original
            // SHA1 is taken from the manifest)
    ...
    public void testRewriteVerifyError() throws Throwable {
        try {
            ...
            JarWriter jw =
                    new JarWriter(
                            Paths.get(
                                    "./src/test/resources/org.eclipse.equinox.cm_1.0.400.v20120319-2029.jar"));
            jw.addManifestEntry("Test", "JUnit test entry");
