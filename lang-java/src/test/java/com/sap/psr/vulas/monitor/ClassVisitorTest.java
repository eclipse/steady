...
public class ClassVisitorTest extends AbstractGoalTest {
  ...
  /**
   * Test the handling of (1) the first constructor of non-static inner classes, (2) the handling of
  ...
  public void testNonStaticInnerClassConstructor() {
    try {
      ...
      final JavaClassId cid =
          JavaId.parseClassQName("com.sap.psr.vulas.monitor.ClassVisitorTest$NonStaticInner");
