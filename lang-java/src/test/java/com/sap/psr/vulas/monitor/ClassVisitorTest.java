...
public class ClassVisitorTest extends AbstractGoalTest {
    ...
    public void testPrettyPrint() {
        final String src =
                "try {if(!VUL_TRC_XGETALIGNMENT_635905){Class vul_cls = null;if(vul_cls==null) {"
                    + " try { vul_cls=$0.getClass(); } catch(Exception e) {} }if(vul_cls==null) {"
                    + " try { vul_cls=java.lang.invoke.MethodHandles.lookup().lookupClass(); }"
                    + " catch(Exception e) {} }if(vul_cls==null) { try { vul_cls=$class; }"
                    + " catch(Exception e) {} }final ClassLoader"
                    + " vul_cls_ldr=vul_cls.getClassLoader();java.net.URL vul_cls_res ="
                    + " null;if(vul_cls_ldr!=null)vul_cls_res=vul_cls_ldr.getResource(vul_cls.getName().replace('.',"
                    + " '/') + \".class\");java.util.Map params = new"
                    + " java.util.HashMap();params.put(\"junit\","
                    + " \"false\");params.put(\"counter\", new"
                    + " Integer(1));VUL_TRC_XGETALIGNMENT_635905=com.sap.psr.vulas.monitor.trace.TraceCollector.callback(\"METHOD\",\"org.openxmlformats.schemas.wordprocessingml.x2006.main.impl.CTPTabImpl.xgetAlignment()\",vul_cls_ldr,vul_cls_res,\"BF0D37E25A643FD4527731790F174BE26AB74A07\",\"com.acme\",\"vulas-testapp\",\"2.1.0-SNAPSHOT\",params);}}"
                    + " catch(Throwable e) { System.err.println(e.getClass().getName() + \""
                    + " occured during execution of instrumentation code in JAVA METH"
    ...
    public void testVisitMethodsInstr() {
        try {
            ...
            System.setProperty(
                    ...
                    "com.sap.psr.vulas.monitor.trace.SingleStackTraceInstrumentor,com.sap.psr.vulas.monitor.touch.TouchPointInstrumentor");
            ...
            final Path p1 =
                    Paths.get("./target/tmp/com/sap/psr/vulas/java/test/Vanilla.foo(String).java");
            final Path p2 =
                    Paths.get("./target/tmp/com/sap/psr/vulas/java/test/Vanilla.vuln(String).java");
            ...
            final File vanilla_class_file =
                    new File("./target/tmp/com/sap/psr/vulas/java/test/Vanilla.class");
        ...
        try {
            ...
            final JavaClassId cid =
                    JavaId.parseClassQName(
                            "com.sap.psr.vulas.monitor.ClassVisitorTest$NonStaticInner");
            ...
            // Expected result (no first parameter of type outer class, no diamond for type
            // parameters)
            final JavaConstructorId expected =
                    JavaId.parseConstructorQName(
                            "com.sap.psr.vulas.monitor.ClassVisitorTest$NonStaticInner(Map)");
    ...
    public void testFixQName() {
        assertTrue(
                ClassVisitor.removeParameterQualification("a.b.c.Class()").equals("a.b.c.Class()"));
        assertTrue(
                ClassVisitor.removeParameterQualification("a.b.c.Class(int)")
                        .equals("a.b.c.Class(int)"));
        assertTrue(
        ...
        assertTrue(
                ClassVisitor.removeParameterQualification(
                                "a.b.c.Class(int,C,boolean,a.b.c.ddd.Test)")
