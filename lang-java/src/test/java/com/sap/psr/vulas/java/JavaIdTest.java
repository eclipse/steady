...
public class JavaIdTest {
    ...
    public void methodIdTest() {
        ...
        final JavaClassId c = new JavaClassId(p, "TestClass");
        final JavaClassId nc = new JavaClassId(c, "NestedClass");
        final JavaMethodId m =
                new JavaMethodId(nc, "foo", Arrays.asList("java.lang.String", "int"));
        assertEquals(
                "com.sap.research.TestClass$NestedClass.foo(String,int)", m.getQualifiedName());
    ...
    public void testGetJarUrl() {
        try {
            ...
            assertTrue(
                    uj.toString()
                            .matches("^file:/.*/\\.m2/repository/junit/junit/.*/junit-.*\\.jar$"));
            ...
            u =
                    new URL(
                            "jar",
                            "",
                            "file:/org.eclipse.equinox.p2.jarprocessor_1.0.300.v20130327-2119.jar");
            uj = JavaId.getJarUrl(u);
            assertEquals(
                    "file:/org.eclipse.equinox.p2.jarprocessor_1.0.300.v20130327-2119.jar",
                    uj.toString());
