...
public class JarAnalyzerTest {
  ...
  /**
   * The archive "org.apache.servicemix.bundles.jaxb-xjc-2.2.4_1.jar" contains 932 class files below
   * directory 1.0 (900 have been deleted). Those cannot be transformed into {@link JavaClassId}s,
   * and corresponding warning messages are printed.
   *
   * @see Jira VULAS-737
   */
  @Test
