...
public class ASTDeserializeSignComparatorTest {
    ...
    // JSON objects representing the SignatureChange, Defective Signature, Fixed Signature and
    // Unknown Version Signature
    // Current content of the files have the CVE-2014-0050, MultipartStream  - Constructor
    private static final String SIGNATURE_CHANGE_JSON_OBJECT =
            "./src/test/resources/methodBody/deserialize/signatureChange.json";
    private static final String SIGNATURE_JSON_OBJECT_DEF =
            "./src/test/resources/methodBody/deserialize/signatureDef.json";
    private static final String SIGNATURE_JSON_OBJECT_FIXED =
            "./src/test/resources/methodBody/deserialize/signatureFix.json";
    private static final String SIGNATURE_JSON_OBJECT_UNKNOWN =
            "./src/test/resources/methodBody/deserialize/signatureUnknown.json";
    ...
    private Signature astSignUnderTest =
            null; // Random Signature of a construct found in an archive
    ...
    public void testDeserializeAndFixContainmentCheck() {
        ...
        log.info(
                "(Found/Total) Fixes : "
                        + astSignComparator.getMatchedNumChanges()
                        + "/"
                        + astSignComparator.getTotalNumChanges());
        assertTrue(status);
