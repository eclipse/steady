...
public class AbstractGoalTest {
    ...
    public void stop() {
        ...
        VulasConfiguration.getGlobal()
                .setProperty(CoreConfiguration.APP_CTX_GROUP, null, null, false);
        VulasConfiguration.getGlobal()
                .setProperty(CoreConfiguration.APP_CTX_ARTIF, null, null, false);
        VulasConfiguration.getGlobal()
                .setProperty(CoreConfiguration.APP_CTX_VERSI, null, null, false);
        VulasConfiguration.getGlobal()
                .setProperty(
                        VulasConfiguration.getServiceUrlKey(Service.BACKEND), null, null, false);
    }
