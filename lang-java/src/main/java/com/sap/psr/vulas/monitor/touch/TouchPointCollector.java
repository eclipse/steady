...
public class TouchPointCollector {
  ...
  /**
   * Adds the given touch point to the list of touch points collected during the tests. This method
   * is called by the callback method {@link TouchPointCollector#callback(String, String,
   * ClassLoader, URL, boolean, StackTraceElement[], String, String, String, Map)}.
   *
  ...
  /**
   * The instrumentation code created by {@link TouchPointInstrumentor#instrument(StringBuffer,
   * JavaId, CtBehavior, ClassVisitor)} will call this callback method if it is possible to
   * determine the caller (through stack trace analysis).
   *
  ...
  private static class TouchPoint {
    ...
    /**
     * Returns the {@link JarAnalyzer} of the OSS that is part of the {@link TouchPoint}. Depending
     * on the direction of the touch point, this can be the analyzer of the caller or callee.
     *
     * @return
     */
