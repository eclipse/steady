...
/**
 * Common super class of the two trace instrumentors {@link SingleTraceInstrumentor} and {@link
 * StackTraceInstrumentor}. Delegates all class to the {@link TraceCollector}.
 */
public abstract class AbstractTraceInstrumentor extends AbstractInstrumentor {
   ...
   *
   * <p>Note that the instrumentation involves two levels of filtering: First, {@link
   ...
   * {@link IInstrumentor} can apply an additional filter in the implementation of this method. Note
   * that
   */
  @Override
  ...
  /**
   * Merges the constructs of the map into a single set. Returns a TreeSet if _ordered is equal to
   * true, a HashSet otherwise.
   *
   * @param _map a {@link java.util.Map} object.
