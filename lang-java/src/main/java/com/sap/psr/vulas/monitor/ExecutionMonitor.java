 ...
 * during application tests. The collected information is then uploaded to the central Vulas backend
 * using the {@link UploadScheduler}.
 */
public class ExecutionMonitor {
  ...
  /**
   * The goal execution related to a trace collection, will be null for all context determination
   * modes except FIXED.
   *
  ...
  /**
   * Iterates over all configured {@link IInstrumentor}s and calls {@link
   * IInstrumentor#awaitUpload()} for each of them.
   */
  ...
  /**
   * Iterates over all configured {@link IInstrumentor}s and calls {@link
   * IInstrumentor#upladInformation(AbstractGoal, int)} for each of them.
   *
