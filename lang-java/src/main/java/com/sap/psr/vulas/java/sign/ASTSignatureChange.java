...
public class ASTSignatureChange extends DistillerUtil implements SignatureChange {
  ...
  /**
   * Used to create instance of ASTSignatureChange during deserialization of JSON object, when
   * deserializing a ASTSignatureChange, we only have the list of SourceCodeChanges read from the
   * DB.
   *
   ...
   *
   * @param strEntityVersion a {@link
   *     ch.uzh.ifi.seal.changedistiller.model.entities.StructureEntityVersion} object.
   */
  ...
  /**
   * Getter for the field <code>structureEntity</code>.
   *
  ...
  /**
   * Setter for the field <code>structureEntity</code>.
   *
   * @param structureEntity a {@link
   *     ch.uzh.ifi.seal.changedistiller.model.entities.StructureEntityVersion} object.
   */
  ...
  /**
   * Getter for the field <code>mDefSignature</code>.
   *
  ...
  /**
   * Setter for the field <code>mDefSignature</code>.
   *
  ...
  /**
   * Getter for the field <code>mFixSignature</code>.
   *
   * @return a {@link com.sap.psr.vulas.sign.Signature} object.
   */
  ...
  /**
   * Setter for the field <code>mFixSignature</code>.
   *
  ...
  /**
   * Getter for the field <code>listOfChanges</code>.
   *
   * @return a {@link java.util.Set} object.
   */
  ...
  /**
   * Setter for the field <code>listOfChanges</code>.
   *
  ...
  /**
   * Getter for the field <code>mMethodName</code>.
   *
  ...
  /**
   * Setter for the field <code>mMethodName</code>.
   *
   ...
   * {@inheritDoc}
   *
   * <p>Returns the set of edit operations required to change the defective AST int the fixed one.
   * Attention: This method will change the defective signature passed as argument to the
   * constructor.
   */
  @Override
