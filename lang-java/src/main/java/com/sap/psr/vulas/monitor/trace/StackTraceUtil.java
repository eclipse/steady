...
public class StackTraceUtil {
	...
	private ConstructId filterMethods(StackTraceElement _e, List<ConstructId> _methods) throws NotFoundException {
		// To be returned
	...
	private ConstructId filterConstructors(StackTraceElement _e, List<ConstructId> _constructors) throws NotFoundException {
		// To be returned
		ConstructId constructor_found = null;

		final SortedMap<Integer, ConstructId> constructor_line_numbers = new TreeMap<Integer, ConstructId>();
		...
		//[main] WARN  com.sap.psr.vulas.monitor.StackTraceUtil  - None of the constructors at line numbers [132,144,159] matched the stack trace element [org.apache.commons.compress.archivers.zip.ZipArchiveInputStream.<init>(ZipArchiveInputStream.java:87)], return constructor with smallest line number
		//[main] WARN  com.sap.psr.vulas.monitor.StackTraceUtil  - None of the constructors at line numbers [97,111,136,145,158] matched the stack trace element [org.apache.commons.compress.archivers.zip.ZipArchiveEntry.<init>(ZipArchiveEntry.java:86)], return constructor with smallest line number
