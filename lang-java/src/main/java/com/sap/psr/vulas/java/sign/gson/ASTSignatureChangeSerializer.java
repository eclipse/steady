...
public class ASTSignatureChangeSerializer extends StdSerializer<ASTSignatureChange> {
    ...
    private void writeSourceCodeEntityElement(
            JsonGenerator jgen, String _property_name, SourceCodeEntity _entity)
            throws IOException {
        ...
        for (SourceCodeChange change : value.getListOfChanges()) {
            ...
            if (change instanceof Insert) {
                this.writeSourceCodeEntityElement(
                        jgen, "InsertedEntity", change.getChangedEntity());
            ...
            // MOVE OPERATION
                ...
                this.writeSourceCodeEntityElement(
                        jgen, "OldParentEntity", change.getParentEntity());
                ...
                this.writeSourceCodeEntityElement(
                        jgen, "NewEntity", ((Move) change).getNewEntity());
            }
            // UPDATE OPERATION
            else if (change instanceof Update) {
                this.writeSourceCodeEntityElement(
                        jgen, "NewEntity", ((Update) change).getNewEntity());
                this.writeSourceCodeEntityElement(
