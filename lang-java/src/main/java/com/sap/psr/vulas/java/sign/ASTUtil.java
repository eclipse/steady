...
public class ASTUtil {
  ...
  /**
   * Helper method for mapping the JaveEntityTypes for source code entities to string name of
   * EntityType in the JSON TODO : It might be better to move this into a BaseClass, might also be
   * used for deserializing SourceCodeChange
   *
   * @return Corresponding EntityType
   *     <p>Number of SourceCodeEntityTypes
