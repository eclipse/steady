...
public class ASTConstructBodySignature extends ASTSignature {
   ...
   * @return - JSON representation of the AST NB : An ast as an array of Nodes A Node {"name" :
   *     "Value of Node", "parent" : "value of parent Node", "children" : [{"name" : "value of
   *     node", "parent" : "value of parent Node"},......,{}]}
   */
   ...
   * (http://www.inf.unibz.it/dis/projects/tree-edit-distance/documentation.php) Format of Tree
   * Structure : {root{node{node}}{node}...}
   */
