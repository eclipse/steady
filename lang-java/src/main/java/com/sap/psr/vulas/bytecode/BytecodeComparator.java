        ...
        try {
            ...
            for (ConstructChange cc : b1.getConstructChanges()) {
                ...
                if (cc.getConstructChangeType().equals(ConstructChangeType.MOD)
                    ...
                    JavaId jid =
                            JavaId.getJavaId(
                                    cc.getConstructId().getType().toString(),
                    ...
                    final String entry_name =
                            def_ctx.getQualifiedName().replace('.', '/') + ".class";
                    ...
                    if (entry != null) {
                        ...
                        try (final InputStream ais = archive.getInputStream(entry);
                                final FileOutputStream fos =
                                        new FileOutputStream(classfile.toFile()); ) {
                    ...
                    if (classfile != null) {
                        ...
                        sign =
                                (ASTConstructBodySignature)
                                        sf.createSignature(
                                                JavaId.toSharedType(jid), classfile.toFile());
                    ...
                    if (ast_current != null) {
                        ...
                        for (LibraryId v : ast_mgr.getVulnLids()) {
                            ...
                            if (ast_lid != null) {
                                ...
                                String editV =
                                        BackendConnector.getInstance().getAstDiff(context, body);
                        ...
                        if (vuln && fixed) {
                            log.warn(
                                    "No conclusion taken for vulnerability ["
                                            ...
                                            + "]: Construct of change "
                                            + cc.toString()
                                            + " is equal both to a vulnerable and to a fixed"
                                            + " archive");
                            break;
                        }
                    }
                ...
                //			String cls_current =
                // BackendConnector.getInstance().getSourcesForQnameInLib(context,
        ...
        if (vuln ^ fixed) {
            ...
            BackendConnector.getInstance()
                    .uploadBugAffectedLibraries(
                            ...
                            b1.getBugId(),
                            json.getJson(),
                            AffectedVersionSource.CHECK_CODE);
        }
