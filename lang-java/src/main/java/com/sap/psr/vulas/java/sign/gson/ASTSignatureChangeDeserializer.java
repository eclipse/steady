...
public class ASTSignatureChangeDeserializer extends StdDeserializer<SignatureChange> {
    ...
    private SourceCodeEntity getSourceCodeEntityElement(JsonNode srcCodeEntityJsonObject) {
        ...
        JsonNode srcCodeEntitySrcRangeJsonObject =
                srcCodeEntityJsonObject.get(SRC_ENTITY_SOURCE_RANGE);
        int srcRangeStart =
                srcCodeEntitySrcRangeJsonObject.get(SRC_ENTITY_SOURCE_RANGE_START).asInt();
    ...
    public SignatureChange deserialize(JsonParser p, DeserializationContext ctxt)
        ...
        EntityType type =
                ASTUtil.getJavaEntityType(
                        strEntity_root.findValue(STRUCTURE_ENTITY_ENTITY_TYPE).asText());
        ...
        if (changesJsonArray.isArray()) {
            for (final JsonNode change : changesJsonArray) {
                // Depending on the "OperationType" of the "changes" element, initialize the
                // appropriate sourceCodeChange element (Insert, Update, Move, Delete)
                ...
                if (operationType.equals("Insert")) {
                    ...
                    SourceCodeEntity movedEntity =
                            this.getSourceCodeEntityElement(change.get("MovedEntity"));
