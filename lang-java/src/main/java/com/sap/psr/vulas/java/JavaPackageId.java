...
public class JavaPackageId extends JavaId {
  ...
  /**
   * The default package has an empty string as qualified name. It is used when working with
   * classes, interfaces or enums that do not belong to a package.
   */
  ...
  /**
   * Returns true if the given {@link JavaPackageId} corresponds to the {@link
   * JavaPackageId#DEFAULT_PACKAGE}, false otherwise.
   *
   * @param _pid a {@link com.sap.psr.vulas.java.JavaPackageId} object.
   * @return a boolean.
   */
  public static final boolean isDefaultPackage(JavaPackageId _pid) {
    return DEFAULT_PACKAGE.equals(_pid);
  }
}
