...
public class ASTSignatureDeserializer implements JsonDeserializer<Signature> {
    ...
    // We need only to change these value if the name/value pair of a JsonElement changes in the
    // json representation of the signature
    // For instance, if we want to  compress  the json object for not storing a large data in the
    // DB.
    ...
    public Signature deserialize(
        ...
        // Instantiate the ASTConstructBodySignature object here (We can have instance of Node
        // object with the above two informations)
        ...
        int srcRangeEnd =
                srcCodeEntitySrcRangeJsonObject.get(SRC_ENTITY_SOURCE_RANGE_END).getAsInt();
