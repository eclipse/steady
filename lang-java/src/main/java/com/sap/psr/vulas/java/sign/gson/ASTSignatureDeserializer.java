...
/**
 * This class is used to deserialize an AST JSON representation of a construct body object into its
 * corresponding java Signatures object /**
 *
 * <p>JSON representation of ASTConstructBodySignature:
 *
 * <p>Node: - fLabel : EntityType - fValue : String
 *
 * <p>-- fMatched : boolean -- fOrdered : boolean
 *
 * <p>- fEntity : SourceCodeEntity - fUniqueName : String //same information as fValue above - fType
 * : EntityType //same information ast fLabel above - fModifiers : int // this is always zero (Not
 * sure if i should have it in the json object) - fAssociatedEntities : List&lt;SourceCodeEntity&gt;
 * - SourceRange fRange : SourceRange - end : int - start : int - fAssociatedNodes :
 * List&lt;Node&gt;
 */
