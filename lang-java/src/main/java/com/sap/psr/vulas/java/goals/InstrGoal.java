...
public class InstrGoal extends AbstractAppGoal {
  ...
  /**
   * Getter for the field <code>libPath</code>.
   *
  ...
  /**
   * Setter for the field <code>libPath</code>.
   *
  ...
  /**
   * Getter for the field <code>inclPath</code>.
   *
   * @return a {@link java.nio.file.Path} object.
   */
  ...
  /**
   * Setter for the field <code>inclPath</code>.
   *
   * @param _p a {@link java.nio.file.Path} object.
   * @throws java.lang.IllegalArgumentException if any.
   */
  ...
  /**
   * Getter for the field <code>targetPath</code>.
   *
   * @return a {@link java.nio.file.Path} object.
   */
  ...
  /**
   * Setter for the field <code>targetPath</code>.
   *
   * @param _p a {@link java.nio.file.Path} object.
   * @throws java.lang.IllegalArgumentException if any.
   */
  ...
  /**
   * Getter for the field <code>instrPaths</code>.
   *
