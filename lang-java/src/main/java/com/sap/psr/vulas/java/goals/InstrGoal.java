...
public class InstrGoal extends AbstractAppGoal {
    ...
    public void addInstrPath(Path _p) throws IllegalArgumentException {
        if (!FileUtil.isAccessibleDirectory(_p) && !FileUtil.isAccessibleFile(_p))
            ...
            log.debug(
                    "["
                            + _p
                            + "] is already part of intrumentation paths, and will not be added"
                            + " another time");
    ...
    protected void prepareExecution() throws GoalConfigurationException {
        ...
        try {
            ...
            this.addInstrPaths(
                    FileUtil.getPaths(
                            this.getConfiguration()
                                    .getStringArray(CoreConfiguration.INSTR_SRC_DIR, null)));
    ...
    protected void executeTasks() throws Exception {
        ...
        final ArchiveAnalysisManager mgr =
                new ArchiveAnalysisManager(no_threads, timeout, true, app);
        mgr.setRename(true);
        ...
        // this.addGoalStats("instr.archivesInstrumentedFileSizeTotal",
        // mgr.getInstrumentedFileSize());
        ...
        // Number of classes in the JAR or WAR. For WARs, also the libs in WB/INF/lib are
        // considered.
        // this.addGoalStats("instr.classesInstrumentedTotal", mgr.countClassesTotal());
        // this.addGoalStats("instr.classesInstrumentedAlready",
        // mgr.countClassesInstrumentedAlready());
        // this.addGoalStats("instr.classesInstrumentedSuccess",
        // mgr.countClassesInstrumentedSuccess());
        // this.addGoalStats("instr.classesInstrumentedFailure",
        // mgr.countClassesInstrumentedFailure());
