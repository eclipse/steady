...
public class JavaEnumId extends JavaId {
  ...
  /**
   * Returns true if the enum is not directly declared within a package, but within another
   ...
   * {@inheritDoc}
   *
   * <p>Returns the fully qualified class name, i.e., including the name of the package in which the
   * class is defined.
   */
  @Override
  public String getQualifiedName() {
    if (this.declarationContext != null) {
      if (!this.isNested()) return this.declarationContext.getQualifiedName() + "." + this.enumName;
      else return this.declarationContext.getQualifiedName() + "$" + this.enumName;
    } else {
  ...
  public String getName() {
    if (this.declarationContext != null) {
      if (!this.isNested()) return this.enumName;
      else return this.declarationContext.getName() + "$" + this.enumName;
    } else {
      return this.enumName;
    }
  }
