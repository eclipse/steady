...
public class PythonFileAnalyzerTest {
	...
	public void testPythonFilesInTestapp() throws FileAnalysisException {
		final FileAnalyzer f1 = FileAnalyzerFactory.buildFileAnalyzer(new File("src/test/resources/testapp/foo/hello_world.py"));
		final Map<ConstructId, Construct> c1 = f1.getConstructs();
		assertEquals(2, c1.size()); // pack, module
		
		final FileAnalyzer f2 = FileAnalyzerFactory.buildFileAnalyzer(new File("src/test/resources/testapp/foo/func_hw.py"));
		final Map<ConstructId, Construct> c2 = f2.getConstructs();
		assertEquals(4, c2.size()); // pack, module, 2 functions
		
		final FileAnalyzer f3 = FileAnalyzerFactory.buildFileAnalyzer(new File("src/test/resources/testapp/foo/class_hw.py"));
		...
		// class_hw.py contains Python 2 syntax. This is to check whether the resp. method is still added when using the Python 3 parser
	    ...
	    final PythonId meth = new PythonId(clas, PythonId.Type.METHOD, "method_of_class_in_func(self,something)");
	...
	public void testPython2() throws FileAnalysisException {
		final FileAnalyzer fa = PythonFileAnalyzer.createAnalyzer(new File("src/test/resources/python2_syntax.py"));
	...
	public void testAsync() throws FileAnalysisException {
		final FileAnalyzer fa = PythonFileAnalyzer.createAnalyzer(new File("src/test/resources/async.py"));
	...
	public void testPythonFilesInTinypy() throws FileAnalysisException {
		final FileAnalyzer f3 = FileAnalyzerFactory.buildFileAnalyzer(new File("src/test/resources/tiny_py_interpreter/tinypy/runtime/Errors.py"));
		final Map<ConstructId, Construct> c3 = f3.getConstructs();
	...
	public void testPythonFileWithAsync() throws FileAnalysisException {
		final FileAnalyzer f3 = FileAnalyzerFactory.buildFileAnalyzer(new File("src/test/resources/corecffi.py"));
		final Map<ConstructId, Construct> c3 = f3.getConstructs();
