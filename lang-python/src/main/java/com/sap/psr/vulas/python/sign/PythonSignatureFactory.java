...
/**
 * Creates construct signatures for several Python constructs. The signature is simply a digest
 * computed over the respective construct body. TODO: Strip comments and the like? TODO: Check the
 * digest algo used by the SW Heritage API
 */
    ...
    // For all others, parse the file, and compute the digest for the construct body
      ...
      try {
        final Python3FileAnalyzer fa =
            (Python3FileAnalyzer) FileAnalyzerFactory.buildFileAnalyzer(_file, new String[] {"py"});
