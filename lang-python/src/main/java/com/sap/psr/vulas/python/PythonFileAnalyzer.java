...
public class PythonFileAnalyzer implements FileAnalyzer {
  ...
  private static final Log log = LogFactory.getLog(PythonFileAnalyzer.class);
  ...
  /**
   * Returns true if the top-most element of the stack is of type {@link ConstructType#MODU}, false
   * otherwise.
   */
  ...
  /**
   * Returns true if the top-most element of the stack is of any of the given {@link
   * PythonId#Type}s, false otherwise.
   */
   ...
   * {@inheritDoc}
   *
   * <p>The nested {@link Python3FileAnalyzer} is completely hidden.
   */
  @Override
   ...
   *
   * <p>TODO: To be completed according to https://docs.python.org/release/3.0.1/whatsnew/3.0.html.
   *
   * <p>As of today, the method searches for the following: - print statement becomes a function:
   * print "bla" --> print("bla") - raw_input does not exist anymore: raw_input() --> input("bla: ")
   */
