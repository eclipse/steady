...
public class VirtualenvWrapper {
  ...
  private static final Log log = LogFactory.getLog(VirtualenvWrapper.class);
  ...
  /**
   * Creates a virtual environment for the project located at the given path. This path is expected
   * to contain a setup.py file.
   *
  ...
  /**
   * Getter for the field <code>pathToVirtualenv</code>.
   *
  ...
  /**
   * Getter for the field <code>installedPackages</code>.
   *
  ...
  /**
   * Creates a virtual environment for the project located at the given path in a temporary
   * directory.
   *
   * @param _project_path
   */
  ...
  private static class CopyFileVisitor extends SimpleFileVisitor<Path> {
    ...
    private static final Log log = LogFactory.getLog(CopyFileVisitor.class);
