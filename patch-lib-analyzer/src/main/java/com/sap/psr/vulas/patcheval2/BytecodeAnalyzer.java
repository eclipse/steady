...
public class BytecodeAnalyzer {
    ...
    public void analyze() throws IOException {
        ...
        //				    		AffectedLibrary[] al =
        // BackendConnector.getInstance().getBugAffectedLibraries(null,
        ...
        //
        //
        //						//loop over affected versions, if the same version for org.apache.tomcat was
        // assessed consistently to VULN/FIXED, propagate it to SHA1 (meant to be used for tomcat >6
        // right now)
        //						for(AffectedLibrary[] array: existingxSource.values()){
        //							for(AffectedLibrary a : array){
        //								if(
        ...
        Iterator<File> it =
                FileUtils.iterateFiles(
                        new File(PEConfiguration.getBaseFolder().toString() + File.separator),
                        null,
                        false);
        // Path p =
    ...
    public static void main(String[] _args) throws IOException {
        ...
        try {
            ...
            //					log.info("Assess all bugs of digest["+digest+"] using metadata, all other options
            // will be ignored.");
