    ...
    public void run() {
        ...
        String[] bugs =
                VulasConfiguration.getGlobal()
                        .getConfiguration()
                        .getStringArray(PEConfiguration.BUGID);
        ProgrammingLanguage lang = null;
        try {
            if (VulasConfiguration.getGlobal().getConfiguration().getString(PEConfiguration.LANG)
                    != null)
                lang =
                        ProgrammingLanguage.valueOf(
                                VulasConfiguration.getGlobal()
                                        .getConfiguration()
                                        .getString(PEConfiguration.LANG));
                        ...
                        Arrays.asList(
                                (Bug[])
                                        JacksonUtil.asObject(
                                                BackendConnector.getInstance().getBugsList(lang),
                                                Bug[].class));
