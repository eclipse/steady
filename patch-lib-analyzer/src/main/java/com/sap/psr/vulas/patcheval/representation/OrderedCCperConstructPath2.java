...
public class OrderedCCperConstructPath2 {
    ...
    public ConstructChangeType getOverallChangeType() {
        ...
        // 			Method
        // org.apache.commons.compress.compressors.bzip2.BlockSort.randomiseBlock(Data,int)
        // 			Added as part of commit 1332540, deleted as part of commit 1340790
        else {
            OrderedCCperConstructPath2.log.info(
                    "Construct ["
                            + this.constructId
                            + "] only existed temporarily (during fix development) and will be"
                            + " ignored for the fix containement check");
