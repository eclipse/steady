...
public class CSVHelper2 {
  ...
  /**
   * This method appends the results for the newly analyzed libraries to an existing file f and
   * returns a string containing ALL results for bugId
   *
