...
/**
 * Class containing all the information computed on a library Id during the first phase (correspond
 * to 1 line in the CSV)
 */
public class LidResult2 implements Comparable<LidResult2> {
  ...
  /**
   * Getter for the field <code>changesToV</code>.
   *
  ...
  /**
   * Setter for the field <code>changesToV</code>.
   *
  ...
  /**
   * Getter for the field <code>changesToF</code>.
   *
   * @return a {@link java.lang.Integer} object.
   */
  ...
  /**
   * Setter for the field <code>changesToF</code>.
   *
  ...
  /**
   * Getter for the field <code>ast_lid</code>.
   *
  ...
  /**
   * Setter for the field <code>ast_lid</code>.
   *
