...
public class CiaTest {
      ...
      try {
        ...
        c =
            BackendConnector.getInstance()
                .getArtifactConstructs("org.apache.tomcat", "tomcat-catalina", "7.0.6");
  ...
  public void getConstructsThreadTest() throws BackendConnectionException {
    ...
    VulasConfiguration.getGlobal()
        .setProperty(CoreConfiguration.BACKEND_CONNECT, CoreConfiguration.ConnectType.READ_ONLY);
    ConstructId a =
        new ConstructId(
            ProgrammingLanguage.JAVA,
            ConstructType.METH,
    ...
    for (Integer i = 2; i < 6; i++) {
      ...
      Callable<List<ConstructPathLibResult2>> thread =
          new LibraryAnalyzerThread2(
              i, l, new LinkedList<OverallConstructChange>(), lib, ProgrammingLanguage.JAVA);
