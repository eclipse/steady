...
public class SootCallgraphConstructor implements ICallgraphConstructor {
   ...
   * {@inheritDoc}
   *
   * <p>Set the context of the application to be analyzed
   */
   ...
   * {@inheritDoc}
   *
   * <p>Filter and find all entrypoints in Scene
   */
   ...
   * {@inheritDoc}
   *
   * <p>Read all configurations and parse command line options, and then build callgraph based on
   * these properties
   */
