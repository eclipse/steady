...
/**
 * Thrown to indicate that a given IVCSClient cannot interact with a VCS repository at the given
 * URL. Reasons can be, for instance, that there is no VCS repository at all or a different type
 * than expected (e.g., GIT instead of SVN). Connectivity problems should NOT be indicated using
 * this exception.
 */
public class RepoMismatchException extends Exception {
  /**
   * Constructor for RepoMismatchException.
   *
