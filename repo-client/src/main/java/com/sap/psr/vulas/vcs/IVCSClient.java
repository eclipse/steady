...
public interface IVCSClient {
  ...
  /**
   * Returns revisions whose commit message contains the provided search string.
   *
  ...
  /**
   * Returns a set of files for a given revision and type of change (Added, Modified, Deleted)
   *
   * @param _rev a {@link java.lang.String} object.
  ...
  /**
   * Returns a path relative to the repo's root for a given absolute path. E.g.,
   * /commons/proper/fileupload/tags for
   * http://svn.apache.org/asf/repos/commons/proper/fileupload/tags
   *
   * @return a {@link java.lang.String} object.
   */
  ...
  /**
   * Performs a checkout of a whole directory Returns a single specific file which is in the
