...
public class CallgraphPathSearch implements Runnable {
  ...
  /**
   * Setter for the field <code>shortestPaths</code>.
   *
  ...
  /**
   * Setter for the field <code>entrypoints</code>.
   *
  ...
  /**
   * Setter for the field <code>targetpoints</code>.
   *
    ...
    for (com.sap.psr.vulas.shared.json.model.ConstructId cid : this.targetpoints) {
      ...
      if (this.graph.existsInCallgraph(cid)) {
        ...
        if (reachable_target_points.contains(cid)) {
          ...
          Map<com.sap.psr.vulas.shared.json.model.ConstructId, LinkedList<Integer>> searched_paths =
              null;
          ...
          for (com.sap.psr.vulas.shared.json.model.ConstructId ep : this.entrypoints) {
            if (this.graph.existsInCallgraph(ep)) {
              ...
              if (spath != null) {
                ...
                final LinkedList<com.sap.psr.vulas.shared.json.model.ConstructId> newpath =
                    new LinkedList<com.sap.psr.vulas.shared.json.model.ConstructId>();
                newpath.add(ep);
  ...
  /**
   * Getter for the field <code>paths</code>.
   *
