...
/**
 * Checks whether a given {@link ConstructId} is part of the application, a library and whether it
 * is blacklisted. The method is used when searching for touch points.
 */
public class MethodNameFilter {
  ...
  /**
   * If there is a MethodNameFilter instance available it will return it, otherwise instantiate it
   * and then return
   *
  ...
  /**
   * Check if the argument is a string representing a method of an external library (meaning not of
   * my application). To define the domain of the application we use the entries on which we built
   * the graph.
   *
   * @param app_entries Entry methods that we used to define the app domain. Use {@link
   *     BackendConnector#getAppConstructIds(com.sap.psr.vulas.goals.GoalContext,
   *     com.sap.psr.vulas.shared.json.model.Application)} to get them.
   * @param value a string representing the complete name of a method
  ...
  /**
   * Check if the argument is a string representing a method of my application (meaning not of an
   * external library). To define the domain of the application we use the entries on which we built
   * the graph.
   *
   * @param app_entries Entry methods that we used to define the app domain. Use {@link
   *     BackendConnector#getAppConstructIds(com.sap.psr.vulas.goals.GoalContext,
