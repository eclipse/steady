...
public class PathSimilarity {
  ...
  // group all paths based on the node joint, the map key is the qname of the node joint, the value
  // are all paths id in this group, id is read from ArrayList paths
