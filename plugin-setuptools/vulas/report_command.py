...
class report(Command):
    ...
    description = 'Runs the vulnerability-assessment-tool goal REPORT'
    ...
    def run(self):
        print("Starting vulnerability-assessment-tool goal: REPORT")
        ...
        # Run the CLI
        rc = cli_wrapper.run(args, "report", self.debug)
