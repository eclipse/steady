...
(select distinct a.mvn_group as app_group,a.artifact as app_artifact,a.version as app_version,d.filename,d.scope,d.transitive,l.sha1,cc.bug,lid.mvn_group,lid.artifact,lid.version,al.affected
...
UNION
(select distinct a.mvn_group as app_group,a.artifact as app_artifact,a.version as app_version,d.filename,d.scope,d.transitive,l.sha1,cc.bug,lid.mvn_group,lid.artifact,lid.version,alsha1.affected
from app a join app_dependency d on a.id=d.app
join lib l on d.lib=l.sha1
join lib_constructs lc on l.id=lc.library_id
join bug_construct_change cc on lc.constructs_id=cc.construct_id
