...
public class ConstructChange implements Serializable {
   ...
   * @param changeType a {@link org.eclipse.steady.backend.model.ConstructChangeType} object.
   */
  public ConstructChange(
      String repo,
      String commit,
   ...
   *
   * @return a {@link org.eclipse.steady.backend.model.ConstructChangeType} object.
   */
