...
public class ConstructChangeInDependency implements Serializable {
  ...
  private org.eclipse.steady.backend.model.AffectedConstructChange.ChangeType overall_change;
   ...
   * <p>Constructor for ConstructChangeInDependency.</p>
   *
   * @param cc a {@link org.eclipse.steady.backend.model.ConstructChange} object.
   */
   ...
   *
   * @return a {@link org.eclipse.steady.backend.model.Trace} object.
   */
   ...
   *
   * @param trace a {@link org.eclipse.steady.backend.model.Trace} object.
   */
   ...
   */
  public org.eclipse.steady.backend.model.AffectedConstructChange.ChangeType getOverall_change() {
    return overall_change;
  }
  /**
   * <p>Setter for the field <code>overall_change</code>.</p>
   *
   * @param changeType a {@link org.eclipse.steady.backend.model.AffectedConstructChange.ChangeType} object.
   */
  public void setOverall_change(
      org.eclipse.steady.backend.model.AffectedConstructChange.ChangeType changeType) {
