...
public class LibraryIdController {
  ...
  @RequestMapping(
      ...
      produces = {"application/json;charset=UTF-8"})
  @JsonView(Views.LibraryIdDetails.class)
  public ResponseEntity<List<org.eclipse.steady.shared.json.model.LibraryId>> getArtifactVersions(
      @PathVariable String mvnGroup,
      @PathVariable String artifact,
    ...
    if (secureOnly && vulnerableOnly) {
      ...
      return new ResponseEntity<List<org.eclipse.steady.shared.json.model.LibraryId>>(
    ...
    try {
      ...
      List<org.eclipse.steady.shared.json.model.LibraryId> vuln_libids =
          new ArrayList<org.eclipse.steady.shared.json.model.LibraryId>();
      List<org.eclipse.steady.shared.json.model.LibraryId> greater_libids =
          new ArrayList<org.eclipse.steady.shared.json.model.LibraryId>();
      ...
      final TreeSet<org.eclipse.steady.shared.json.model.LibraryId> all_libids =
      ...
      if (greaterThanVersion == null && !latest) {
        ...
        all_libids.addAll(
            (Collection<org.eclipse.steady.shared.json.model.LibraryId>) greater_libids);

      final List<org.eclipse.steady.shared.json.model.LibraryId> result =
          new ArrayList<org.eclipse.steady.shared.json.model.LibraryId>();
      ...
      if (all_libids != null) {
        ...
        Boolean found = false;
        for (org.eclipse.steady.shared.json.model.LibraryId a : all_libids) {
          found = false;
          // If vulnerable should be included, take the one known locally, as it is has
          // vulnerability info
          for (org.eclipse.steady.shared.json.model.LibraryId b : vuln_libids) {
