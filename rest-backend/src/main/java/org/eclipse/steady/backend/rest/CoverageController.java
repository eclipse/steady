...
import org.eclipse.steady.shared.enums.CoverageStatus;
  ...
  public ResponseEntity<CoverageStatusResponse> isCovered(@PathVariable String bugid) {
    ...
    try {
      ...
      try {
        ...
        if (cve != null) response.setDescription(cve.getSummary());
        ...
        // All other cases
          ...
          if (create_issue != null && !create_issue.equals("")) {
            ...
            response.setActionText(
                "Create a Jira ticket if this CVE affects an open-source software component"
                    + " developed in Java or Python.");
          }
        }
