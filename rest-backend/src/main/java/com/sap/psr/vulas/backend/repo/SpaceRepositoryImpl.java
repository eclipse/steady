...
public class SpaceRepositoryImpl implements SpaceRepositoryCustom {
   ...
   * {@inheritDoc}
   *
   * <p>Returns the default space for the given tenant token. In case the tenant token is not
   * provided, it uses the default tenant. If the default space for the given tenant or the default
   * tenant do not exist, it returns null.
   */
   ...
   * {@inheritDoc}
   *
   * <p>Returns the space for the given space token. In case a space token is not provided, it
   * returns the default space of the default tenant (if existing, null otherwise)
   */
