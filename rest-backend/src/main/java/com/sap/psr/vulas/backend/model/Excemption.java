...
/**
 * Holds information regarding the exception of a {@link VulnerableDependency}. This information is
 * computed by comparing several goal configuration settings with the properties of the {@link
...
public class Excemption {
  ...
  /**
   * Setter for the field <code>excludedScope</code>.
   *
  ...
  /**
   * Setter for the field <code>excludedBug</code>.
   *
  ...
  /**
   * Getter for the field <code>excludedBugReason</code>.
   *
  ...
  /**
   * Setter for the field <code>excludedBugReason</code>.
   *
