...
public class DependencyRepositoryImpl implements DependencyRepositoryCustom {
     ...
     */
    public Set<ConstructId> saveReachableConstructIds(
            Dependency _dep, ConstructId[] _construct_ids) {
        ...
        managed_construct_ids.addAll(
                this.refUpdater.saveNestedConstructIds(provided_construct_ids));
