...
public class StatisticsContributor implements InfoContributor {
    ...
    public void contribute(Info.Builder builder) {
        ...
        //  vulasStats.put("confirmed_vulnDeps_count",
        // appVulDepRepository.countConfirmedVulnDeps());
        ...
        vulasStats.put(
                ...
                appVulDepRepository.countConfirmedVulnerableLatestGroup());
        // number of groups with at least one vulndeps '!' or '?'
        //    vulasStats.put("vulnerable_groups_count",
        // appVulDepRepository.countVulnerableGroups());
        ...
        vulasStats.put(
                "latest_group_artifacts_count", appVulDepRepository.countLatestGroupArtifacts());
        ...
        //    vulasStats.put("group_artifact_versions_count",
        // appVulDepRepository.countLatestGAVs());
        ...
        gaStats.put(
                "group_artifact_vulndepCount",
                appVulDepRepository.getVulnDepsLatestGroupArtifacts());
