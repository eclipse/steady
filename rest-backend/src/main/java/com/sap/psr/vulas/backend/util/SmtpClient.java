...
public class SmtpClient {
     ...
     */
    public void send(@NotNull com.sap.psr.vulas.backend.util.Message _msg)
            throws MessagingException {
        if (_msg.hasAttachment()) this.sendWithAttachement(_msg);
        else log.error("Messages without attachment are not supported");
    }

    private void sendWithAttachement(@NotNull com.sap.psr.vulas.backend.util.Message _msg)
            throws MessagingException {
