...
public class ServiceWrapper {
    ...
    public Collection<LibraryId> getAllArtifactVersions(
        ...
        try {
            ...
            throw new ServiceConnectionException(
                    "Cannot create service URI from [" + url + "]", use);
        }
     ...
     * @throws com.sap.psr.vulas.shared.connectivity.ServiceConnectionException if any.
     */
    public JarDiffResult diffJars(LibraryId _old, LibraryId _new)
            throws ServiceConnectionException {
        final String service_url = VulasConfiguration.getGlobal().getServiceUrl(Service.CIA, true);
        ...
        try {
            ...
            final RestTemplate rest_template = new RestTemplate();
            result =
                    rest_template.postForObject(url, artifacts, JarDiffResult.class, (Object) null);
                                ...
                                new HttpEntity<String>(
                                        this.createHeaders(
                                                VulasConfiguration.getGlobal()
                                                        .getConfiguration()
                                                        .getString(
                                                                VulasConfiguration.VULAS_JIRA_USER),
                                                VulasConfiguration.getGlobal()
                                                        .getConfiguration()
                                                        .getString(
                                                                VulasConfiguration
