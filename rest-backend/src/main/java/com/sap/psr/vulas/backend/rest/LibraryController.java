...
public class LibraryController {
   ...
   * @return 404 {@link HttpStatus#NOT_FOUND} if library with given digest does not exist, 200
   *     {@link HttpStatus#OK} if the library is found
   */
  @RequestMapping(
      value = "/{digest}",
      method = RequestMethod.GET,
   ...
   *
   * @param digest a {@link java.lang.String} object.
   * @return 404 {@link HttpStatus#NOT_FOUND} if no application depends on the given digest or
   *     digest does not exists, 200 {@link HttpStatus#OK} if the applications are found
   */
  @RequestMapping(
      value = "/{digest}/apps",
      method = RequestMethod.GET,
   ...
   *
   * @param digest a {@link java.lang.String} object.
   * @return 404 {@link HttpStatus#NOT_FOUND} if library with given digest does not exist, 422
   *     {@link HttpStatus.UNPROCESSABLE_ENTITY} if the value of path variable (digest) is not equal
   *     to the corresponding field in the body 200 {@link HttpStatus#OK} if the library was
  ...
  /**
   * Updates the meta-data of a {@link Library} with a given digest. In particular it updates the
   * digest verified flag and release timestamp fields.
   *
   * @param digest a {@link java.lang.String} object.
   * @return 404 {@link HttpStatus#NOT_FOUND} if library with given digest does not exist, 200
   *     {@link HttpStatus#OK} if the library metadata were successfully updated
   * @param skipResponseBody a {@link java.lang.Boolean} object.
   */
  @RequestMapping(
  ...
  /**
   * Deletes the {@link Library} with the given external ID. This ID is provided by the user when
  ...
  /**
   * @param digest
   * @return 404 {@link HttpStatus#NOT_FOUND} if the library file needs to be uploaded (not known to
   *     Maven central and not already uploaded), 200 otherwise
   */
  ...
  @RequestMapping(
      ...
      produces = {"application/json;charset=UTF-8"})
  @JsonView(Views.Default.class)
  public ResponseEntity<Set<com.sap.psr.vulas.shared.json.model.LibraryId>> getLibraryLibId(
      @PathVariable String digest) {
    try {
      ...
      Set<com.sap.psr.vulas.shared.json.model.LibraryId> results =
      ...
      Collection<com.sap.psr.vulas.shared.json.model.LibraryId> toProcess =
      ...
      if (true) {
        ...
        for (com.sap.psr.vulas.shared.json.model.LibraryId lid : toProcess) {
          ...
          List<com.sap.psr.vulas.shared.json.model.ConstructId> other_pack =
              ServiceWrapper.getInstance()
          ...
          if (equal) {
            List<com.sap.psr.vulas.shared.json.model.ConstructId> other =
                ServiceWrapper.getInstance()
                    .getArtifactConstructs(
      ...
      return new ResponseEntity<Set<com.sap.psr.vulas.shared.json.model.LibraryId>>(
