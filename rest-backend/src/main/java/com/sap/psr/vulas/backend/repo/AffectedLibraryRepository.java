...
/** AffectedLibraryRepository interface. */
@Repository
public interface AffectedLibraryRepository
   ...
   */
  @Query(
      "SELECT afflib FROM AffectedLibrary AS afflib WHERE afflib.bugId = :bug AND afflib.libraryId.mvnGroup = :group AND afflib.libraryId.artifact = :artifact  AND afflib.libraryId.version = :version AND afflib.source = :source")
   ...
   */
  @Query(
      "SELECT afflib FROM AffectedLibrary AS afflib WHERE afflib.bugId = :bug AND afflib.source = :source")
  List<AffectedLibrary> findByBugAndSource(
      @Param("bug") Bug bug, @Param("source") AffectedVersionSource source);

  /**
   * findByBugAndLibIdAndSource.
   *
   * @param bug a {@link com.sap.psr.vulas.backend.model.Bug} object.
   * @param source a {@link com.sap.psr.vulas.shared.enums.AffectedVersionSource} object.
   * @param group a {@link java.lang.String} object.
   ...
   */
  @Query(
      "SELECT afflib FROM AffectedLibrary AS afflib WHERE afflib.bugId = :bug AND afflib.source = :source AND afflib.libraryId.mvnGroup = :group AND afflib.libraryId.artifact = :artifact AND afflib.libraryId.version = :version")
   ...
   */
  @Query(
      "SELECT afflib FROM AffectedLibrary AS afflib WHERE afflib.bugId = :bug AND afflib.libraryId.mvnGroup = :group AND afflib.libraryId.artifact = :artifact AND afflib.libraryId.version = :version")
   ...
   */
  @Query(
      "SELECT afflib FROM AffectedLibrary AS afflib WHERE afflib.bugId = :bug AND afflib.source = :source AND afflib.lib = :digest")
   ...
   */
  @Query(
      "SELECT affcc FROM AffectedConstructChange AS affcc JOIN affcc.affectedLib afflib WHERE afflib.bugId = :bug AND afflib.lib = :digest")
   ...
   */
  @Query(
      "SELECT distinct afflib.bugId FROM AffectedLibrary AS afflib WHERE afflib.libraryId.mvnGroup = :group AND afflib.libraryId.artifact = :artifact AND afflib.libraryId.version = :version")
  ...
  /**
   * Same as {@link AffectedLibraryRepository#findBugByLibraryId(String, String, String)}, but
   * offering an additional filter for selected bug ID(s).
   *
   * @param group a {@link java.lang.String} object.
   * @param artifact a {@link java.lang.String} object.
   * @param version a {@link java.lang.String} object.
   ...
   */
  @Query(
      "SELECT distinct afflib.bugId FROM AffectedLibrary AS afflib WHERE afflib.libraryId.mvnGroup = :group AND afflib.libraryId.artifact = :artifact AND afflib.libraryId.version = :version AND afflib.bugId.bugId IN :bugIds ")
  List<Bug> findBugByLibraryId(
      @Param("group") String group,
      @Param("artifact") String artifact,
      @Param("version") String version,
   ...
   */
  @Query(
      "SELECT afflib FROM AffectedLibrary AS afflib WHERE afflib.libraryId.mvnGroup = :group AND afflib.libraryId.artifact = :artifact  AND afflib.libraryId.version = :version")
   ...
   */
  @Query(
      "SELECT afflib FROM AffectedLibrary AS afflib WHERE afflib.libraryId.mvnGroup = :group AND afflib.libraryId.artifact = :artifact ")
  ...
  @Query(
      value =
          "	select a.affected from "
              ...
              + " where a.bug_id=:bug_id and a.lib=:lib",
      nativeQuery = true)
  ...
  @Query(
      value =
          "	select a.affected from "
              ...
              + " where a.bug_id=:bug_id and a.library_id=:library_id",
      nativeQuery = true)
