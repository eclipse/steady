...
public class DigestVerifierEnumerator implements DigestVerifier {
    ...
    public List<LibraryId> verify(Library _lib) throws VerificationException {
        ...
        // Will only have a list of LibraryIds or an empty list if either one verifier returns
        // (thus, no exception happened)
        ...
        for (DigestVerifier l : loader) {
            ...
            if ((developed_in.isEmpty()
                            || u.haveIntersection(developed_in, l.getSupportedLanguages()))
