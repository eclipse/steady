...
public class CveReader2 implements ObjectFetcher<String, Cve> {
    ...
    private static final Cve buildFromJson(String _id, String _json) throws ParseException {
        ...
        final JSONArray descriptions =
                JsonPath.read(
                        document, "$.cve.description.description_data[?(@.lang=='en')].value");
        ...
        try {
            ...
            log.warn(
                    "Exception when reading CVSS v3 information for CVE ["
                            + _id
                            + "]: "
                            + e.getMessage());
        }
        ...
        try {
            ...
            log.warn(
                    "Exception when reading CVSS v2 information for CVE ["
                            + _id
                            + "]: "
                            + e.getMessage());
        }
