...
public class CveReader2 implements ObjectFetcher<String, Cve> {
  ...
  /**
   * Returns CVE information for the given key (or null in case the key is null). This information
   * is retrieved from a (remote) service configured with {@link #CVE_SERVICE_URL}.
   *
   * @param _key a {@link java.lang.String} object.
   * @return a {@link com.sap.psr.vulas.backend.cve.Cve} object.
   * @throws com.sap.psr.vulas.shared.cache.CacheException if any.
  ...
  public Cve fetch(String _key) throws CacheException {
    ...
    final String url =
        VulasConfiguration.getGlobal().getConfiguration().getString(CVE_SERVICE_URL, null);
    if (url == null)
