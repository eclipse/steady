...
// Note, the unique constraint is not defined as an annotation any longer as we need more
// expressiveness than what JPA allows
// The new constraints are defined in the flyway migration V20180828.1730__depParent.sql as partial
// indexes
