...
/**
 * {@link CrudRepository#findOne(java.io.Serializable)} only works for the primary key of the
 * respective {@link Entity}. All other "find" methods that can be specified in the extended
 * interface only return {@link Collection}s of objects that match the search criteria. This class
...
public class ResultSetFilter<T> {
   ...
   * @throws {@link EntityNotFoundException} if the given collection is empty or contains multiple
   *     elements
