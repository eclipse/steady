...
public class TenantControllerTest {
	...
	public void testTenantCreation() throws Exception {
		...
		com.sap.psr.vulas.shared.json.model.Tenant new_shared_tenant = new com.sap.psr.vulas.shared.json.model.Tenant();
		...
		new_shared_tenant.setTenantToken(TEST_DEFAULT_TENANT); // Token does not matter, will be generated anyways server-side
		

		MockHttpServletRequestBuilder post_builder = post("/tenants")
	...
	public void testGetTenant() throws Exception {
		...
		final Tenant tenant = TenantRepository.FILTER.findOne(this.tenantRepository.findBySecondaryKey(TEST_DEFAULT_TENANT));
		...
		MockHttpServletRequestBuilder get_builder = get("/tenants/" + TEST_DEFAULT_TENANT)
				.accept(MediaType.APPLICATION_JSON);
