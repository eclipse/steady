...
public class TenantControllerTest {
  ...
  public void testTenantCreation() throws Exception {
    ...
    org.eclipse.steady.shared.json.model.Tenant new_shared_tenant =
        new org.eclipse.steady.shared.json.model.Tenant();
    ...
    new_shared_tenant.setTenantToken(
        TEST_DEFAULT_TENANT); // Token does not matter, will be generated anyways server-side
