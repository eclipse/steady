...
public class ResponseDoc implements Comparable {
  ...
  /**
   * Setter for the field <code>c</code>.
   *
  ...
  /**
   * Getter for the field <code>p</code>.
   *
   * @return a {@link java.lang.String} object.
   */
  public String getP() {
  ...
  /**
   * Setter for the field <code>p</code>.
   *
  ...
  /**
   * Getter for the field <code>ec</code>.
   *
  ...
  /**
   * Setter for the field <code>ec</code>.
   *
   ...
   * {@inheritDoc}
   *
   * <p>Compares the respective timestamps.
   */
  @Override
