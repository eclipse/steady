...
/**
 * Visits all kinds of changes and creates instances of the classes contained in package {@link
 * com.sap.psr.vulas.cia.dependencyfinder.model}. Inspired from {@link com.jeantessier.diff.Report}.
 */
public class JarDiffVisitor extends VisitorBase {
  ...
  /**
   * Constructor for JarDiffVisitor.
   *
  ...
  /**
   * Getter for the field <code>jarDiffResult</code>.
   *
  ...
  /**
   * Setter for the field <code>jarDiffResult</code>.
   *
  ...
  private com.sap.psr.vulas.shared.json.model.ConstructId getClass(Classfile _classfile) {
    com.sap.psr.vulas.shared.json.model.ConstructId c =
        new com.sap.psr.vulas.shared.json.model.ConstructId();
