...
/**
 * Used to echo the Http request header X-Vulas-Echo to clients. This header allows Http clients to
 * maintain the context in which a certain Ajax call has been done.
 */
public class HeaderEcho {
  ...
  /**
   * If the given echo value is not null and not an empty {@link String}, the method returns {@link
   * HttpHeaders} with the identical value for the header field X-Vulas-Echo. Otherwise, the {@link
   * HttpHeaders} are empty.
   *
