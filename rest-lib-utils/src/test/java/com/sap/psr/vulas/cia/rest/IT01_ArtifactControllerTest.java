...
public class IT01_ArtifactControllerTest {
    ...
    public void getAllVersionsExistingTest() {
        ...
        try {
            Set<Artifact> response =
                    r.getAllArtifactVersions(
                            "commons-fileupload", "commons-fileupload", null, null);
            System.out.println(response.size());
            // the number of returned version is not stable (13/14..) assert modified to checked
            // greater to avoid failures due to external services
    ...
    public void getLatestVersionPythonTest() {
        ...
        try {
            ...
            assertTrue(
                    new Version(response.getLibId().getVersion()).compareTo(new Version("2.0.4"))
                            > 0);
    ...
    public void getArtifactVersionPythonTest() {
        ...
        try {
            Artifact response =
                    r.getArtifactVersion(
                            "django", "django", "1.2.2", null, null, ProgrammingLanguage.PY);
