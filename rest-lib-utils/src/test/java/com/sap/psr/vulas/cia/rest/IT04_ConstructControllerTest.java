...
public class IT04_ConstructControllerTest {
	...
	public void getConstructforGavTest(){
		...
		JavaId jid =JavaId.parseMethodQName("org.apache.cxf.jaxrs.provider.atom.AbstractAtomProvider.readFrom(Class,Type,Annotation[],MediaType,MultivaluedMap,InputStream)");
		JavaId ctx = (JavaId) jid.getDefinitionContext();
		Path file = ClassDownloader.getInstance().getClass("org.apache.cxf",
				"cxf-rt-rs-extension-providers",
				"2.6.2-sap-02", ctx.getQualifiedName(), 
