  ...
  public void vulasAppTest() {
    ...
    assertTrue(
        ...
        buildResult
            .getOutput()
            .matches(
                "(?s).*Save app \\[com.sap.security.vulas.gradle.plugin.test:android-lib1:1.0.0\\] with \\[2\\] dependencies and \\[3\\] constructs .*"));
    assertTrue(
        "Dependency/construct count mismatch",
        buildResult
            .getOutput()
            .matches(
                "(?s).*Save app \\[com.sap.security.vulas.gradle.plugin.test:android-lib2:1.0.0\\] with \\[5\\] dependencies and \\[3\\] constructs .*"));
  }
}
