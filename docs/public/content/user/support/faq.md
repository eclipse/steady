...
[vulas-shutdown-trace-upload] INFO  com.sap.psr.vulas.backend.requests.BasicHttpRequest  - HTTP GET [uri=http://@@HOST@@:@@PORT@@/backend/apps/XXXXXX/XXXXXX/XXXXXX/bugs?historical=false, proxy=false]
