...
The process of importing vulnerabiilty data from [Project KB](https://github.com/SAP/project-kb) to the backend of @@PROJECT_NAME@@ is
realized using two tools: `kaybee` (from project KB) and `kb-importer` (part of @@PROJECT_NAME@@).
