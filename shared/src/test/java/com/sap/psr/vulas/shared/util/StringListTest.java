...
public class StringListTest {
    ...
    public void testContains() {
    	...
    	assertTrue(  whitelist.contains("foo.bar.Test",  ComparisonMode.STARTSWITH, CaseSensitivity.CASE_SENSITIVE));
    	assertTrue(  whitelist.contains("foo.BAR.Test",  ComparisonMode.STARTSWITH, CaseSensitivity.CASE_INSENSITIVE));
    	assertTrue( !whitelist.contains("foo.BAR.Test",  ComparisonMode.STARTSWITH, CaseSensitivity.CASE_SENSITIVE));
    	assertTrue( !whitelist.contains("top.down.Test", ComparisonMode.STARTSWITH, CaseSensitivity.CASE_SENSITIVE));
	...
	public void testFilter() {
    	...
    	// keep_matches = true
    	final Map<String, String> o1 = list.filter(m, true, ComparisonMode.EQUALS, CaseSensitivity.CASE_SENSITIVE);
    	assertTrue(!o1.containsKey("foo.bar"));
    	assertTrue(!o1.containsKey("john.doe"));
    	
    	final Map<String, String> o3 = list.filter(m, true, ComparisonMode.EQUALS, CaseSensitivity.CASE_INSENSITIVE);
    	assertTrue( o3.containsKey("foo.bar"));
    	assertTrue(!o3.containsKey("john.doe"));
    	
    	// keep_matches = false
    	final Map<String, String> o2 = list.filter(m, false, ComparisonMode.EQUALS, CaseSensitivity.CASE_SENSITIVE);
    	assertTrue( o2.containsKey("foo.bar"));
    	assertTrue( o2.containsKey("john.doe"));
    	
    	final Map<String, String> o4 = list.filter(m, false, ComparisonMode.EQUALS, CaseSensitivity.CASE_INSENSITIVE);
