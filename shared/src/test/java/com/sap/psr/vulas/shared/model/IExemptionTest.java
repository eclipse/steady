...
public class IExemptionTest {
    ...
    public void testReadFromConfiguration() {
        ...
        c1.setProperty(
                ExemptionScope.DEPRECATED_CFG, "teST, PROVided"); // Will result in 2 exemptions
    ...
    public void testIsExempted() {
        try {
            ...
            // scope = SYSTEM, cvssScore = 7.5, wellknownDigest = false, affected_version_confirmed
            // = 0
    ...
    public void testSerialization() {
        ...
        try {
            // digest = 6F1EBC6CE20AD8B3D4825CEB2E625E5C432A0E10, bugId = CVE-2014-0050, scope =
            // SYSTEM, cvssScore = 7.5, wellknownDigest = false, affected_version_confirmed = 0
            final VulnerableDependency vd =
                    (VulnerableDependency)
                            JacksonUtil.asObject(
                                    FileUtil.readFile("./src/test/resources/vulndep.json"),
    ...
    public void testCreatePackageUrl() {
        ...
        try {
            ...
            assertTrue(true);
            assertEquals(
                    "Package URLs of type [maven] require a valid namespace and name: ["
                            + purl
                            + "]",
                    e.getMessage());
        }
        ...
        try {
            ...
            assertTrue(true);
            assertEquals(
                    "Package URLs of type [npm] are not supported: [" + purl + "]", e.getMessage());
        }
    }
}
