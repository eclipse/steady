...
public class IExemptionTest {
  ...
  public void testReadFromConfiguration() {
    ...
    c1.setProperty(
        ExemptionBug.DEPRECATED_CFG_PREFIX,
        "CVE-2014-0050, CVE-2014-0051"); // Will result in 2 exemptions
    ...
    c1.setProperty(
        ExemptionBug.CFG_PREFIX + ".CVE-2014-0054.libraries",
        "pkg:maven/g@1.9.1, pkg:npm/g@1.9.1"); // No exemptions due to wrong PURLs
  ...
  public void testIsExempted() {
    try {
      ...
      final VulnerableDependency vd =
          (VulnerableDependency)
              JacksonUtil.asObject(
                  FileUtil.readFile("./src/test/resources/vulndep.json"),
                  VulnerableDependency.class);

      // * exemptions
      assertTrue(
          this.getExemption(ExemptionBug.CFG_PREFIX, "CVE-2014-0050", "Lorem ipsum", "*")
              .isExempted(vd));
      assertFalse(
          this.getExemption(ExemptionBug.CFG_PREFIX, "CVE-2014-0051", "Lorem ipsum", "*")
              .isExempted(vd));

      // Digest exemptions
      assertTrue(
          this.getExemption(
                  ExemptionBug.CFG_PREFIX,
                  "CVE-2014-0050",
                  "Lorem ipsum",
                  "6F1EBC6CE20AD8B3D4825CEB2E625E5C432A0E10")
              .isExempted(vd));
      ...
      assertTrue(
          this.getExemption(
                  ...
                  "CVE-2014-0050",
                  "Lorem ipsum",
                  "pkg:maven/stuff/stuff@stuff")
              .isExempted(vd));
      assertTrue(
          this.getExemption(
                  ExemptionBug.CFG_PREFIX, "CVE-2014-0050", "Lorem ipsum", "pkg:maven/stuff/stuff")
              .isExempted(vd));
      assertFalse(
          this.getExemption(
                  ExemptionBug.CFG_PREFIX,
      ...
      assertFalse(
          this.getExemption(
                  ...
                  "CVE-2014-0050",
                  "Lorem ipsum",
                  "pkg:maven/stuff/foo@stuff")
              .isExempted(vd));

      // Old format for bugs
      assertTrue(
          this.getExemption(
                  ExemptionBug.DEPRECATED_CFG_PREFIX, "CVE-2014-0050", "Lorem ipsum", null)
              .isExempted(vd));
      assertFalse(
          this.getExemption(
                  ExemptionBug.DEPRECATED_CFG_PREFIX, "CVE-2014-0051", "Lorem ipsum", null)
              .isExempted(vd));
  ...
  public void testSerialization() {
    ...
    c3.setProperty(
        ...
        "Lorem ipsum"); // Will result in 1 exemption
    c3.setProperty(
    ...
    c5.setProperty(
        ExemptionBug.CFG_PREFIX + ".CVE-2014-0050.reason",
        "Lorem ipsum"); // Will result in 2 exemption
    c5.setProperty(
        ExemptionBug.CFG_PREFIX + ".CVE-2014-0050.libraries",
        "123, pkg:maven/stuff/stuff@stuff, abc");
    final ExemptionSet e5 = ExemptionSet.createFromConfiguration(c5.getConfiguration());
    assertEquals(3, e5.size());

    try {
      // digest = 6F1EBC6CE20AD8B3D4825CEB2E625E5C432A0E10, bugId = CVE-2014-0050, scope = SYSTEM,
      // cvssScore = 7.5, wellknownDigest = false, affected_version_confirmed = 0
      final VulnerableDependency vd =
          (VulnerableDependency)
              JacksonUtil.asObject(
                  FileUtil.readFile("./src/test/resources/vulndep.json"),
      ...
      assertTrue(
          serialized_vd != null
              && serialized_vd.indexOf(
                      "\"exemption\":{\"bugId\":\"CVE-2014-0050\",\"library\":\"*\",\"reason\":\"No"
                          + " reason provided\"}")
                  != -1);
      ...
      assertTrue(
          serialized_vd != null
              && serialized_vd.indexOf(
                      "\"exemption\":{\"reason\":\"Vulnerable dependencies with scope [SYSTEM] are"
                          + " exempted through configuration settings [vulas.report.exemptScope]"
                          + " or [vulas.report.exceptionScopeBlacklist] (deprecated)\"}")
                  != -1);
      ...
      assertTrue(
          serialized_vd != null
              && serialized_vd.indexOf(
                      "\"exemption\":{\"bugId\":\"CVE-2014-0050\",\"library\":\"6F1EBC6CE20AD8B3D4825CEB2E625E5C432A0E10\",\"reason\":\"Lorem"
                          + " ipsum\"}")
                  != -1);
      ...
      assertTrue(
          serialized_vd != null
              && serialized_vd.indexOf(
                      "\"exemption\":{\"bugId\":\"CVE-2014-0050\",\"library\":\"*\",\"reason\":\"Lorem"
                          + " ipsum\"}")
                  != -1);
      ...
      assertTrue(
          serialized_vd != null
              && serialized_vd.indexOf(
                      "\"exemption\":{\"bugId\":\"CVE-2014-0050\",\"library\":\"pkg:maven/stuff/stuff@stuff\",\"reason\":\"Lorem"
                          + " ipsum\"}")
                  != -1);
