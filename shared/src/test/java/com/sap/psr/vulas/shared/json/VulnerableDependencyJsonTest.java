    ...
    public void testVulnerableDependecyDeserialization() {
        ...
        inputNew =
                (VulnerableDependency)
                        JacksonUtil.asObject(vulndepstring, VulnerableDependency.class);
        ...
        Assert.assertEquals(
                ...
                "{\"ast\":[ {\"Value\" : \"process\",\"SourceCodeEntity\" :{ \"Modifiers\" :"
                    ...
                    + " \"METHOD\",\"C\" : [{\"Value\" : \"(request =="
                    + " null)\",\"SourceCodeEntity\" :{ \"Modifiers\" : \"0\",\"SourceRange\" :"
                    + " {\"Start\" : 144,\"End\" : 257}},\"EntityType\" : \"IF_STATEMENT\",\"C\" :"
                    + " [{\"Value\" : \"(request == null)\",\"SourceCodeEntity\" :{ \"Modifiers\""
                    + " : \"0\",\"SourceRange\" : {\"Start\" : 165,\"End\" : 257}},\"EntityType\""
                    + " : \"THEN_STATEMENT\",\"C\" : [{\"Value\" : \"new"
                    + " IllegalArgumentException(\"HTTP request may not be"
                    + " null\");\",\"SourceCodeEntity\" :{ \"Modifiers\" : \"0\",\"SourceRange\" :"
                    + " {\"Start\" : 180,\"End\" : 246}},\"EntityType\" :"
                    + " \"THROW_STATEMENT\"}]}]},{\"Value\" : \"(context =="
                    + " null)\",\"SourceCodeEntity\" :{ \"Modifiers\" : \"0\",\"SourceRange\" :"
                    + " {\"Start\" : 268,\"End\" : 381}},\"EntityType\" : \"IF_STATEMENT\",\"C\" :"
                    + " [{\"Value\" : \"(context == null)\",\"SourceCodeEntity\" :{ \"Modifiers\""
                    + " : \"0\",\"SourceRange\" : {\"Start\" : 289,\"End\" : 381}},\"EntityType\""
                    + " : \"THEN_STATEMENT\",\"C\" : [{\"Value\" : \"new"
                    + " IllegalArgumentException(\"HTTP context may not be"
                    + " null\");\",\"SourceCodeEntity\" :{ \"Modifiers\" : \"0\",\"SourceRange\" :"
                    ...
                    + " \"\",\"SourceCodeEntity\" :{ \"Modifiers\" : \"0\",\"SourceRange\" :"
                    + " {\"Start\" : 459,\"End\" : 465}},\"EntityType\" :"
                    + " \"RETURN_STATEMENT\"}]}]},{\"Value\" : \"AuthState authState = (AuthState)"
                    ...
                    + " null)\",\"SourceCodeEntity\" :{ \"Modifiers\" : \"0\",\"SourceRange\" :"
                    + " {\"Start\" : 667,\"End\" : 699}},\"EntityType\" : \"THEN_STATEMENT\",\"C\""
                    + " : [{\"Value\" : \"\",\"SourceCodeEntity\" :{ \"Modifiers\" :"
                    + " \"0\",\"SourceRange\" : {\"Start\" : 682,\"End\" : 688}},\"EntityType\" :"
                    + " \"RETURN_STATEMENT\"}]}]},{\"Value\" : \"AuthScheme authScheme ="
                    + " authState.getAuthScheme();\",\"SourceCodeEntity\" :{ \"Modifiers\" :"
                    + " \"0\",\"SourceRange\" : {\"Start\" : 712,\"End\" : 761}},\"EntityType\" :"
                    + " \"VARIABLE_DECLARATION_STATEMENT\"},{\"Value\" : \"(authScheme =="
                    + " null)\",\"SourceCodeEntity\" :{ \"Modifiers\" : \"0\",\"SourceRange\" :"
                    + " {\"Start\" : 772,\"End\" : 828}},\"EntityType\" : \"IF_STATEMENT\",\"C\" :"
                    + " [{\"Value\" : \"(authScheme == null)\",\"SourceCodeEntity\" :{"
                    + " \"Modifiers\" : \"0\",\"SourceRange\" : {\"Start\" : 796,\"End\" :"
                    + " 828}},\"EntityType\" : \"THEN_STATEMENT\",\"C\" : [{\"Value\" :"
                    + " \"\",\"SourceCodeEntity\" :{ \"Modifiers\" : \"0\",\"SourceRange\" :"
                    + " {\"Start\" : 811,\"End\" : 817}},\"EntityType\" :"
                    + " \"RETURN_STATEMENT\"}]}]},{\"Value\" : \"Credentials creds ="
                    + " authState.getCredentials();\",\"SourceCodeEntity\" :{ \"Modifiers\" :"
                    + " \"0\",\"SourceRange\" : {\"Start\" : 841,\"End\" : 887}},\"EntityType\" :"
                    + " \"VARIABLE_DECLARATION_STATEMENT\"},{\"Value\" : \"(creds =="
                    + " null)\",\"SourceCodeEntity\" :{ \"Modifiers\" : \"0\",\"SourceRange\" :"
                    ...
                    + " : \"THEN_STATEMENT\",\"C\" : [{\"Value\" : \"this.log.debug(\"User"
                    + " credentials not available\");\",\"SourceCodeEntity\" :{ \"Modifiers\" :"
                    + " \"0\",\"SourceRange\" : {\"Start\" : 932,\"End\" : 980}},\"EntityType\" :"
                    + " \"METHOD_INVOCATION\"},{\"Value\" : \"\",\"SourceCodeEntity\" :{"
                    + " \"Modifiers\" : \"0\",\"SourceRange\" : {\"Start\" : 995,\"End\" :"
                    + " 1001}},\"EntityType\" : \"RETURN_STATEMENT\"}]}]},{\"Value\" :"
                    + " \"((authState.getAuthScope() != null) || (!"
                    + " authScheme.isConnectionBased()))\",\"SourceCodeEntity\" :{ \"Modifiers\" :"
                    + " \"0\",\"SourceRange\" : {\"Start\" : 1023,\"End\" : 1747}},\"EntityType\""
                    + " : \"IF_STATEMENT\",\"C\" : [{\"Value\" : \"((authState.getAuthScope() !="
                    + " null) || (! authScheme.isConnectionBased()))\",\"SourceCodeEntity\" :{"
                    + " \"Modifiers\" : \"0\",\"SourceRange\" : {\"Start\" : 1096,\"End\" :"
                    + " 1747}},\"EntityType\" : \"THEN_STATEMENT\",\"C\" : [{\"Value\" :"
                    + " \"\",\"SourceCodeEntity\" :{ \"Modifiers\" : \"0\",\"SourceRange\" :"
                    + " {\"Start\" : 1111,\"End\" : 1736}},\"EntityType\" :"
                    + " \"TRY_STATEMENT\",\"C\" : [{\"Value\" : \"\",\"SourceCodeEntity\" :{"
                    + " \"Modifiers\" : \"0\",\"SourceRange\" : {\"Start\" : 1115,\"End\" :"
                    + " 1528}},\"EntityType\" : \"BODY\",\"C\" : [{\"Value\" : \"Header"
                    ...
                    + " : \"THEN_STATEMENT\",\"C\" : [{\"Value\" : \"header ="
                    + " ((ContextAwareAuthScheme) authScheme).authenticate(creds, request,"
                    + " context);\",\"SourceCodeEntity\" :{ \"Modifiers\" : \"0\",\"SourceRange\""
                    + " : {\"Start\" : 1239,\"End\" : 1353}},\"EntityType\" :"
                    + " \"ASSIGNMENT\"}]},{\"Value\" : \"(authScheme instanceof"
                    + " ContextAwareAuthScheme)\",\"SourceCodeEntity\" :{ \"Modifiers\" :"
                    + " \"0\",\"SourceRange\" : {\"Start\" : 1379,\"End\" : 1469}},\"EntityType\""
                    + " : \"ELSE_STATEMENT\",\"C\" : [{\"Value\" : \"header ="
                    + " authScheme.authenticate(creds, request);\",\"SourceCodeEntity\" :{"
                    + " \"Modifiers\" : \"0\",\"SourceRange\" : {\"Start\" : 1402,\"End\" :"
                    + " 1450}},\"EntityType\" : \"ASSIGNMENT\"}]}]},{\"Value\" :"
                    + " \"request.addHeader(header);\",\"SourceCodeEntity\" :{ \"Modifiers\" :"
                    + " \"0\",\"SourceRange\" : {\"Start\" : 1488,\"End\" : 1513}},\"EntityType\""
                    + " : \"METHOD_INVOCATION\"}]},{\"Value\" : \"\",\"SourceCodeEntity\" :{"
                    + " \"Modifiers\" : \"0\",\"SourceRange\" : {\"Start\" : 1529,\"End\" :"
                    + " 1736}},\"EntityType\" : \"CATCH_CLAUSES\",\"C\" : [{\"Value\" :"
                    ...
                    + " : \"THEN_STATEMENT\",\"C\" : [{\"Value\" : \"this.log.error((\"Proxy"
                    + " authentication error: \" + ex.getMessage()));\",\"SourceCodeEntity\" :{"
                    + " \"Modifiers\" : \"0\",\"SourceRange\" : {\"Start\" : 1638,\"End\" :"
                    + " 1702}},\"EntityType\" : \"METHOD_INVOCATION\"}]}]}]}]}]}]}]}]}]}");
    }
