...
public class VulasConfigurationTest {
  ...
  public void testCheckSettings() {
    ...
    assertFalse(ce == null);
    assertEquals(
        "The following mandatory settings are not specified: [bar], the following settings do not comply with the required format: []",
        ce.getMessage());
  }
  ...
  public void testCheckSettingsFormatWrong() {
    ...
    assertFalse(ce == null);
    assertEquals(
        "The following mandatory settings are not specified: [], the following settings do not comply with the required format: [vulas.bar]",
        ce.getMessage());
  }
