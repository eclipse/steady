...
public class VulasConfigurationTest {
    ...
    public void testConfigurationChange() {
        ...
        boolean added =
                VulasConfiguration.getGlobal()
                        .appendConfigurationsFromJar(VulasConfigurationTest.class);
        assertFalse(added);
        ...
        assertEquals(
                cfg_1.getString(VulasConfiguration.TMP_DIR),
                cfg_2.getString(VulasConfiguration.TMP_DIR));
        ...
        assertEquals(
                "test-value", VulasConfiguration.getGlobal().getConfiguration().getString("1"));
    ...
    public void testStringArray() {
        ...
        String[] a1 =
                VulasConfiguration.getGlobal().getStringArray("does-not-exist", default_array);
    ...
    public void testNestedJars() {
        ...
        assertEquals(
                "123",
                VulasConfiguration.getGlobal().getConfiguration().getString("vulas.test-key-3"));
        assertEquals(
                "abc",
                VulasConfiguration.getGlobal().getConfiguration().getString("vulas.test-key-4"));
    }
    ...
    public void testToKeyValue() {
        KeyValue[] values =
                KeyValue.toKeyValue(
                        VulasConfiguration.getGlobal().getConfiguration().subset("vulas"));
    ...
    public void testIndependentConfigChanges() {
        ...
        assertTrue(
                !c1.getConfiguration()
                        .getString("foo")
                        .equals(c2.getConfiguration().getString("foo")));
    }
    ...
    public void testGetServiceHeaders() {
        ...
        c1.setProperty(
                "vulas.shared.backend.header.X-Vulas-Client-Token", "AJDEY@HEX@EWX@XEH@I*QA");
