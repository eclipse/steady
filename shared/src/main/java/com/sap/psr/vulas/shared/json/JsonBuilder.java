...
public class JsonBuilder {
  ...
  /**
   * Supports appending array elements and object properties by adding a comma to the buffer unless
   * the last char is equal to [ or { (i.e., the beginning of an array or object).
   */
  ...
  /**
   * Appends an object property with the given name and value. The value is escaped depending on the
   * boolean parameter _escape.
   *
   * @param _property a {@link java.lang.String} object.
   * @param _value a {@link java.lang.String} object.
