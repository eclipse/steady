 ...
 *
 * <p>Example services comprise, for instance, the backend service where analysis results are
 * stored, or the cia service that provides information on Java archives, classes and single
 * methods.
 */
public enum Service {
  BACKEND((byte) 10),
