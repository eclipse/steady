...
public class JarDiffResult {
    ...
    public void addModifiedInterface(ClassDiffResult _class) {
        if (this.modifiedInterfaces == null)
            this.modifiedInterfaces = new HashSet<ClassDiffResult>();
    ...
    public void addDeprecatedInterface(ConstructId _class) {
        if (this.deprecatedInterfaces == null)
            this.deprecatedInterfaces = new HashSet<ConstructId>();
        ...
        if (_cid.getType() == ConstructType.PACK)
            ...
            if (idx == -1)
                throw new IllegalArgumentException(
                        "Cannot determine . in qname [" + _cid.getQname() + "]");
            else
                ccid =
                        new ConstructId(
                                _cid.getLang(),
