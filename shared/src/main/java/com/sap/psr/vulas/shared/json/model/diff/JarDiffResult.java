...
public class JarDiffResult {
  ...
  /**
   * Getter for the field <code>oldLibId</code>.
   *
  ...
  /**
   * Setter for the field <code>oldLibId</code>.
   *
  ...
  /**
   * Getter for the field <code>newLibId</code>.
   *
   * @return a {@link com.sap.psr.vulas.shared.json.model.LibraryId} object.
   */
  ...
  /**
   * Setter for the field <code>newLibId</code>.
   *
  ...
  /**
   * Getter for the field <code>newPackages</code>.
   *
  ...
  /**
   * Setter for the field <code>newPackages</code>.
   *
  ...
  /**
   * Getter for the field <code>deletedPackages</code>.
   *
   * @return a {@link java.util.Set} object.
   */
  ...
  /**
   * Setter for the field <code>deletedPackages</code>.
   *
  ...
  /**
   * Getter for the field <code>newClasses</code>.
   *
   * @return a {@link java.util.Set} object.
   */
  ...
  /**
   * Setter for the field <code>newClasses</code>.
   *
  ...
  /**
   * Getter for the field <code>modifiedClasses</code>.
   *
   * @return a {@link java.util.Set} object.
   */
  ...
  /**
   * Setter for the field <code>modifiedClasses</code>.
   *
  ...
  /**
   * Getter for the field <code>deletedClasses</code>.
   *
   * @return a {@link java.util.Set} object.
   */
  ...
  /**
   * Setter for the field <code>deletedClasses</code>.
   *
  ...
  /**
   * Getter for the field <code>deprecatedClasses</code>.
   *
   * @return a {@link java.util.Set} object.
   */
  ...
  /**
   * Setter for the field <code>deprecatedClasses</code>.
   *
  ...
  /**
   * Getter for the field <code>undeprecatedClasses</code>.
   *
   * @return a {@link java.util.Set} object.
   */
  ...
  /**
   * Setter for the field <code>undeprecatedClasses</code>.
   *
  ...
  /**
   * Getter for the field <code>newInterfaces</code>.
   *
   * @return a {@link java.util.Set} object.
   */
  ...
  /**
   * Setter for the field <code>newInterfaces</code>.
   *
  ...
  /**
   * Getter for the field <code>modifiedInterfaces</code>.
   *
   * @return a {@link java.util.Set} object.
   */
  ...
  /**
   * Setter for the field <code>modifiedInterfaces</code>.
   *
  ...
  /**
   * Getter for the field <code>deletedInterfaces</code>.
   *
   * @return a {@link java.util.Set} object.
   */
  ...
  /**
   * Setter for the field <code>deletedInterfaces</code>.
   *
  ...
  /**
   * Getter for the field <code>deprecatedInterfaces</code>.
   *
   * @return a {@link java.util.Set} object.
   */
  ...
  /**
   * Setter for the field <code>deprecatedInterfaces</code>.
   *
  ...
  /**
   * Getter for the field <code>undeprecatedInterfaces</code>.
   *
   * @return a {@link java.util.Set} object.
   */
  ...
  /**
   * addUndeprecatedInterface.
   *
   * @param _class a {@link com.sap.psr.vulas.shared.json.model.ConstructId} object.
   */
  public void addUndeprecatedInterface(ConstructId _class) {
    if (this.undeprecatedInterfaces == null)
      this.undeprecatedInterfaces = new HashSet<ConstructId>();
    this.undeprecatedInterfaces.add(_class);
  }
  /**
   * Setter for the field <code>undeprecatedInterfaces</code>.
   *
  ...
  /**
   * Returns true if the given construct is deleted from the class, the entire class is deleted or
   * the package is deleted. from the container class.
   *
  ...
  public boolean isDeleted(@NotNull ConstructId _cid) {
    ...
    boolean del =
        this.deletedPackages != null && pack != null && this.deletedPackages.contains(pack);
  ...
  /**
   * Returns true if ... from the container class.
   *
   * @param _cid a {@link com.sap.psr.vulas.shared.json.model.ConstructId} object.
   * @return a boolean.
   */
  ...
  public static ConstructId getPackageOf(ConstructId _cid) {
    ...
    if (_cid.getType() == ConstructType.PACK) ccid = _cid;
  ...
  /**
   * Returns a {@link ConstructId} of type {@link ConstructType#CLAS} in which the given construct
   * ID has been declared.
   *
   * @param _cid a {@link com.sap.psr.vulas.shared.json.model.ConstructId} object.
   * @return a {@link com.sap.psr.vulas.shared.json.model.ConstructId} object.
  ...
  public static ConstructId getClassOf(ConstructId _cid) {
    ...
    else if (_cid.getType() == ConstructType.CLAS) ccid = _cid;
    else if (_cid.getType() == ConstructType.INIT || _cid.getType() == ConstructType.METH) {
      int idx = _cid.getQname().lastIndexOf(".");
      // final String ctx = _cid.getQname().substring(0, idx);
      if (idx == -1)
        ...
        ccid =
            new ConstructId(_cid.getLang(), ConstructType.CLAS, _cid.getQname().substring(0, idx));
    } else if (_cid.getType() == ConstructType.CONS) {
