...
/**
 * This class represents software versions as major.minor[.maintenance[.build]]. See
 * https://en.wikipedia.org/wiki/Software_versioning for more information.
 */
public class Version implements Comparable<Version> {
  ...
  /**
   * This method returns the major release of the library, i.e., the string before the first '.', if
   * any; 0 otherwise
   *
  ...
  /**
   * This method returns the maintenance release, i.e., major.minor.maintenance, where minor and
   * maintenance are set to 0 if they do not exist in this.version
   *
  ...
  /**
   * This method returns true if the Version is a maintenance release, i.e., only has 3 fields
   * (major.minor.maintenance) or the fourth is 0 or"RELEASE" (major.minor.maintenance.0||RELEASE)
   *
   * @return major.minor.maintenance
   */
  ...
  /**
   * This method compares versions that only contains numbers. It returns 0 if they are equal or
   * contains letters
   *
   * @return a int.
   */
