...
public class JacksonUtil {
  ...
  /**
   * Serializes the given object to JSON, thereby using no custom {@link StdSerializer}s and no view
   * {@link Class}.
   *
  ...
  /**
   * Serializes the given object to JSON, thereby using the given {@link StdSerializer}s and no view
   * {@link Class}.
   *
   * @param _object a {@link java.lang.Object} object.
  ...
  /**
   * Serializes the given object to JSON, thereby using the given {@link StdSerializer}s and the
   * given view {@link Class}.
   *
   * @param _object a {@link java.lang.Object} object.
   * @param _custom_serializers a {@link java.util.Map} object.
