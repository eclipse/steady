...
public class Application implements Serializable, Comparable<Application> {
  ...
  /**
   * Returns true if the application has {@link ConstructId}s and no {@link Dependency}s, false
   * otherwise. The invocation of {@link Application#isEmpty()} right after {@link
   * Application#clean()} must return true.
   *
