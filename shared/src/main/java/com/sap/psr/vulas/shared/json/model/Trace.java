...
public class Trace implements Serializable {
  ...
  /**
   * ID of the TEST GoalExecution during which the trace was collected. The member is of type {@link
   * String} rather than GoalExecution, as the latter will only be uploaded at the very end of the
   * goal execution, hence, a foreign key relationship could not be satisfied.
   */
