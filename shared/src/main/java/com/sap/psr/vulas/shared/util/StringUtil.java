...
public class StringUtil {
  ...
  /**
   * Returns a string representation of the given nano seconds. In case more than a minute passed,
   * the representation [hhh:mm:ss] will be used, otherwise [ss.SSS ms].
   *
   * @param _nano a long.
   * @return a {@link java.lang.String} object.
   */
  ...
  /**
   * Returns true if the given {@link String} is not null and its length is shorter or equal to the
   * given number. Throws an {@link IllegalArgumentException} otherwise.
   *
  ...
  /**
   * Removes square brackets (if any), splits the given String using comma (,) and returns an array
   * of trimmed values.
   *
   * @param _string a {@link java.lang.String} object.
  ...
  /**
   * Returns true of the given arrayis null, empty or contains only one element that equals an empty
   * {@link String}.
   *
  ...
  /**
   * Returns true if the given String matches to one of the provided {@link Pattern}s, false
   * otherwise.
   *
   * @param _string a {@link java.lang.String} object.
