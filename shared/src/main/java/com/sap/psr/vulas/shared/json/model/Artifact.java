...
public class Artifact implements Serializable, Comparable<Object> {
  ...
  public int compareTo(Object _other) {
    if (_other instanceof Artifact) {
      ...
      int result =
          this.getLibId().getMvnGroup().compareToIgnoreCase(other_libid.getLibId().getMvnGroup());
      if (result == 0)
        result =
            this.getLibId().getArtifact().compareToIgnoreCase(other_libid.getLibId().getArtifact());
  ...
  /**
   * Getter for the field <code>libId</code>.
   *
  ...
  /**
   * Setter for the field <code>libId</code>.
   *
  ...
  /**
   * Getter for the field <code>packaging</code>.
   *
   * @return a {@link java.lang.String} object.
   */
  ...
  /**
   * Setter for the field <code>packaging</code>.
   *
   ...
   * repository. E.g, com/jolira/guice/3.0.0.
   *
   * @return
   */
  @JsonIgnore
  ...
  /**
   * Returns the artifact's filename root, e.g., guice-3.0.0 To be completed with one of the
   * available postfix in this.ec
   *
   * @return a {@link java.lang.String} object.
   */
  @JsonIgnore
  ...
  /**
   * [OUT-OF-DATE] Returns true if group, artifact, version are specified, classifier is one of
   * 'sources', 'javadoc', 'test-sources', and 'tests', and packaging is one of 'pom', 'jar' and
   * 'war'. Without all this information, a download is not possible.
   *
   * @return a boolean.
   */
