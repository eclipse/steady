...
public class ThreadUtil {
  ...
  /**
   * Returns true if the value of configuration setting {@link NO_OF_THREADS} is equal to AUTO,
   * false otherwise.
   *
   * @return
   */
  ...
  /**
   * Returns the number of threads to be used for parallelized processing steps, thereby taking the
   * configuration setting {@link NO_OF_THREADS} and the number of cores into account.
   *
