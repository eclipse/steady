...
/**
 * Indicates how a given path has been found, e.g., through test execution ({@link PathSource#X2C})
 * or via static call graph analysis starting from application methods (@link {@link
 * PathSource#A2C}).
 */
