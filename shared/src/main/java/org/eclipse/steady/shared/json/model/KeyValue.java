...
public class KeyValue {
  ...
  public boolean equals(Object obj) {
    ...
    } else if (!Arrays.equals(value, other.value)) return false;
    return true;
  }
  /** {@inheritDoc} */
  @Override
  public String toString() {
    ...
    else if (value.length == 0) b.append("<empty>");
    else if (value.length == 1) b.append(value[0]);
    else {
      b.append("[");
   ...
   * @return an array of {@link org.eclipse.steady.shared.json.model.KeyValue} objects.
   */
