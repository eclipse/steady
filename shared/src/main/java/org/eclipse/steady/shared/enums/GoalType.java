...
public enum GoalType {
  ...
  public static GoalType parseGoal(String _goal) throws IllegalArgumentException {
    if (_goal == null || _goal.equals("")) throw new IllegalArgumentException("No goal specified");
    for (GoalType t : GoalType.values()) if (t.name().equalsIgnoreCase(_goal)) return t;
