...
sap.ui.controller("view.ASTViewer", {
	...
	_handleRouteMatched : function(evt) {    
                ...
                repo =  evt.getParameter("arguments").repo.replace(/\+/g, "/") // temporary;
                //console.log(repo);
	...
	loadDataIntoView : function() {
	    if(sha1) {
                ...
                var ASTViewerPage = this.getView().byId('idASTViewerPage');
                ...
                if (!model.Config.isMock) {
                    ...
                    oASTViewerModel.attachRequestCompleted(function(){
                        var elements = oASTViewerModel.getObject('/');
                        var x = model.TreeUtils.getOverallChangeModifications(elements,qname,repo);
                        ...
                        // test
                        var tb = model.TreeUtils.getTestedBody(elements,qname,repo);
                        //console.log("------------------");
                        //console.log(tb);
                        ...
                        oTestedTreeF.setModel(oTestedModel);
                        oTestedTreeD.setModel(oTestedModel);
                        oTestedTreeF.expandToLevel(100);
                        oTestedTreeD.expandToLevel(100);
                        oTestedTreeF.setVisibleRowCount(model.TreeUtils.getVisibleRowCountTable(oTestedTreeF));
                        oTestedTreeD.setVisibleRowCount(model.TreeUtils.getVisibleRowCountTable(oTestedTreeD));
