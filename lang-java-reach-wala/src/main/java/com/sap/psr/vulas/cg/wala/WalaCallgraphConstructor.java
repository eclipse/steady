...
public class WalaCallgraphConstructor implements ICallgraphConstructor {
    ...
    private final Set<com.sap.psr.vulas.shared.json.model.ConstructId> filteredEP =
    ...
    public void setEntrypoints(Set<com.sap.psr.vulas.shared.json.model.ConstructId> _constructs)
        ...
        if (_constructs.isEmpty()) {
            ...
            for (com.sap.psr.vulas.shared.json.model.ConstructId cid : _constructs) {
                ...
                if (ProgrammingLanguage.JAVA.equals(cid.getLang())) {
                    ...
                    if (jcid instanceof com.sap.psr.vulas.java.JavaConstructorId
                            || jcid instanceof com.sap.psr.vulas.java.JavaMethodId) {
                    ...
                    for (Iterator<IMethod> m_iter = klass.getDeclaredMethods().iterator();
                        ...
                        if (!method.isClinit()) {
                            ...
                            if (!method.isAbstract()
                                    && (_constructs_qname.contains(method_qname))) {
        ...
        if (this.entrypoints.iterator().hasNext())
            ...
            throw new CallgraphConstructException(
                    "No entry points could be set, which will not allow to build the call graph",
                    null);
    }
    ...
    private static com.sap.psr.vulas.shared.json.model.ConstructId getCid(IMethod _method) {
        ...
        if (_method.isClinit()) {
            ...
            if (_method.isInit()) {
                ...
                params.append(")");
                qname =
                        _method.getSignature().substring(0, _method.getSignature().indexOf("<") - 1)
                                + params;
                ...
                params.append(")");
                qname =
                        _method.getSignature().substring(0, _method.getSignature().indexOf("("))
                                + params;
    ...
    public void buildCallgraph(boolean _policy) throws CallgraphConstructException {
        ...
        try {
            ...
            final AnalysisCache cache =
                    new AnalysisCacheImpl(); // AstIRFactory.makeDefaultFactory());
            ...
            // Wala construction problems sometimes result in NPEs, e.g., if certain language
    ...
    private void checkEntrypoints(boolean _policy) throws CallgraphConstructException {
        HashSet<com.sap.psr.vulas.shared.json.model.ConstructId> ep_diff =
                new HashSet<com.sap.psr.vulas.shared.json.model.ConstructId>();
        com.sap.psr.vulas.shared.json.model.ConstructId cid = null;
        ...
        try {
            this.excludedPackagesFile =
                    FileUtil.writeToTmpFile(
                                    "exclusion",
                                    "txt",
                                    buffer.replaceAll(";", System.getProperty("line.separator")))
                            .toFile();
        } catch (IOException e) {
