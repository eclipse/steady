...
public class BomGoalTest extends AbstractGoalTest {
    ...
    public void testBomWithIncompleteAppConfiguration()
        ...
        this.vulasConfiguration.setProperty(
                CoreConfiguration.APP_CTX_VERSI, null); // Will raise the exception
        ...
        verifyHttp(server)
                .times(0, method(Method.PUT), uri("/backend" + PathBuilder.app(this.testApp)));
        verifyHttp(server)
                .times(
                        0,
                        method(Method.POST),
     ...
     */
    @Test
    public void testBomSkipSaveEmptyApp()
            throws GoalConfigurationException, GoalExecutionException {
        // Mock REST services
        this.configureBackendServiceUrl(server);
        ...
        this.vulasConfiguration.setProperty(
                CoreConfiguration.APP_CTX_ARTIF, this.testApp.getArtifact());
        this.vulasConfiguration.setProperty(
                CoreConfiguration.APP_CTX_VERSI, this.testApp.getVersion());
