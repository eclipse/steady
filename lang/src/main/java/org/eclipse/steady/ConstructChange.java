...
public class ConstructChange implements Comparable<ConstructChange> {
   ...
   * @param _def a {@link org.eclipse.steady.Construct} object.
   * @param _fix a {@link org.eclipse.steady.Construct} object.
  ...
  public ConstructChange(
    ...
    this.fix = _fix;
    this.commit =
        (_rev != null && _rev.contains(":")) ? _rev.substring(0, _rev.indexOf(":") - 1) : _rev;
    ...
    final SignatureFactory factory =
        CoreConfiguration.getSignatureFactory(
            org.eclipse.steady.ConstructId.toSharedType(
  ...
  public String toString() {
    ...
    // Note : It will not be generated for these constructs (CLASS, CLASSINIT, PACKAGE) but these
    ...
    if (signatureChange != null) {
      buffer.append(
          System.getProperty("line.separator") + "AST_Diff_json  : " + signatureChange.toJSON());
      buffer.append(System.getProperty("line.separator"));
    }
  ...
  public boolean equals(Object obj) {
    ...
    final ConstructId tc =
        (this.def != null
            ? org.eclipse.steady.ConstructId.toSharedType(this.def.getId())
            : org.eclipse.steady.ConstructId.toSharedType(this.fix.getId()));
    final ConstructId oc =
        (other.def != null
            ? org.eclipse.steady.ConstructId.toSharedType(other.def.getId())
            : org.eclipse.steady.ConstructId.toSharedType(other.fix.getId()));
  ...
  public final int compareTo(ConstructChange _cc) {
    ...
    if (id_comparison_result == 0 && this.commit != null) return this.commit.compareTo(_cc.commit);
