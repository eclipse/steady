...
public interface Task {
  ...
  /**
   * Provides the task with application {@link Dependency}s that are already known before task
   * execution. This information may come from build systems or the like, and typically facilitates
   * the task execution.
   *
  ...
  /**
   * Performs the actual application analysis. Right after, task-specific methods can be used to
  ...
  /**
   * The analysis of an application is typically dependent on its {@link ProgrammingLanguage}s. This
   * method returns the {@link ProgrammingLanguage}s covered by the {@link Task}.
   *
