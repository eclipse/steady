...
public class BomGoal extends AbstractAppGoal {
    ...
    protected void executeTasks() throws Exception {
        ...
        // The removal of dependencies on the same digest is not done here any longer to be able to
        // set parents on the dependencies that will not be removed
        // Once we add the usage of relativePath to distinguish among dependencies, the removal can
        // be done at this step again.
                ...
                if (lib != null) {
                    if (lib.hasValidDigest()) {
                        ...
                        if (CoreConfiguration.isJarUploadEnabled(
                                this.getGoalContext().getVulasConfiguration()))
