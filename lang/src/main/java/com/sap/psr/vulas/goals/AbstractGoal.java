...
public abstract class AbstractGoal implements Runnable {
    ...
    public String toJson() throws IllegalStateException {
        ...
        b.append(",\"clientVersion\":")
                .append(JsonBuilder.escape(CoreConfiguration.getVulasRelease()));
                            ...
                            JsonBuilder.escape(
                                    this.exception
                                            ...
                                            .substring(
                                                    0,
                                                    Math.min(
                                                            this.exception.getMessage().length(),
                                                            255))));
        ...
        try {
            ...
            ret =
                    BackendConnector.getInstance()
                            .uploadGoalExecution(this.getGoalContext(), this, _before);
