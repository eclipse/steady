...
public class CoreConfiguration {
  ...
  /**
   * Constant <code>INSTR_BLACKLIST_JAR_SCOPES="vulas.core.instr.blacklist.jars.ignoreS"{trunked}
   * </code>
   */
  ...
  /**
   * Constant <code>
   * INSTR_BLACKLIST_CUSTOM_CLASSES="vulas.core.instr.blacklist.classes.cust"{trunked}</code>
   */
  ...
  /**
   * Constant <code>
   * INSTR_BLACKLIST_CLASSLOADER_ACC_CHILD="vulas.core.instr.whitelist.classloader."{trunked}</code>
   */
  ...
  /**
   * Constant <code>MONI_PERIODIC_UPL_ENABLED="vulas.core.monitor.periodicUpload.enabl"{trunked}
   * </code>
   */
  public static final String MONI_PERIODIC_UPL_ENABLED =
      "vulas.core.monitor.periodicUpload.enabled";
  /**
   * Constant <code>MONI_PERIODIC_UPL_INTERVAL="vulas.core.monitor.periodicUpload.inter"{trunked}
   * </code>
   */
  public static final String MONI_PERIODIC_UPL_INTERVAL =
      "vulas.core.monitor.periodicUpload.interval";
  /**
   * Constant <code>MONI_PERIODIC_UPL_BATCH_SIZE="vulas.core.monitor.periodicUpload.batch"{trunked}
   * </code>
   */
  ...
  /**
   * Returns true if a maximum number of items has been configured via {@link
   * CoreConfiguration#MONI_PERIODIC_MAX_ITEMS} and the given number is greater or equal to this
   * maximum.
   *
  ...
  /**
   * Reads the Manifest file entry "Implementation-Version" from the Java archive from which this
   * class was loaded.
   *
    ...
    if (vulasRelease == null) {
      ...
      if (vulasRelease == null || vulasRelease.equals("")) {
        CoreConfiguration.log.warn(
            "Cannot determine Vulas version from manifest entry [Implementation-Version], check Vulas JAR");
  ...
  /**
   * Loops over available implementations of {@link SignatureFactory}, checks whether the given id
   * is supported and returns an instance.
   *
