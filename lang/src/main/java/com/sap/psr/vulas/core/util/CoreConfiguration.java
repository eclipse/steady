...
public class CoreConfiguration {
    ...
    public static final String INSTR_BLACKLIST_CUSTOM_JARS =
    ...
    public static final String INSTR_BLACKLIST_JRE_CLASSES =
            "vulas.core.instr.blacklist.classes.jre";
    ...
    public static final String INSTR_BLACKLIST_CLASSLOADER =
            "vulas.core.instr.blacklist.classloader";
    ...
    private static ConnectType getBackendConnectType(VulasConfiguration _c) {
        ...
        if ("READ_WRITE".equalsIgnoreCase(value)) return ConnectType.READ_WRITE;
            ...
            throw new IllegalStateException(
                    "Illegal value of configuration setting ["
                            + BACKEND_CONNECT
                            + "]: ["
                            + value
                            + "]");
    ...
    public static Application getAppContext(VulasConfiguration _c) throws ConfigurationException {
        ...
        try {
            a =
                    new Application(
                            c.getString(APP_CTX_GROUP),
                            c.getString(APP_CTX_ARTIF),
                            c.getString(APP_CTX_VERSI));
