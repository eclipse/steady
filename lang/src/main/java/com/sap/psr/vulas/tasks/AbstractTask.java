...
public abstract class AbstractTask implements Task {
  ...
  /**
   * Returns true if the {@link GoalClient} of this task is equal to the given client, false
   * otherwise.
   *
  ...
  /**
   * Getter for the field <code>knownDependencies</code>.
   *
   ...
   * {@inheritDoc}
   *
   * <p>Checks the search {@link Path} and {@link GoalClient}.
   */
  @Override
