...
public class ConditionalHttpRequest extends BasicHttpRequest {
  ...
  /**
   * Setter for the field <code>conditionRequest</code>.
   *
   ...
   * {@inheritDoc}
   *
   * <p>First performs the conditional requests. Only if all the responses meets the condition, the
   * actual request will be performed.
   */
  @Override
