...
public class RequestRepeater {
  ...
  /**
   * Returns true (and waits {@link RequestRepeater#waitMilli} milliseconds) if the response code of
   * the previous HTTP call was 503 and the number of maximum retries has not been reached, false
   * otherwise.
   *
