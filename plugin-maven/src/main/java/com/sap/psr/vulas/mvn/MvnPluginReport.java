...
public class MvnPluginReport extends AbstractVulasMojo {
    ...
    private void collectApplicationModules(MavenProject _prj, Set<Application> _ids) {
        ...
        final Application app =
                new Application(_prj.getGroupId(), _prj.getArtifactId(), pom_version);

        // Override version found in the respective pom.xml with the version of the application
        // context
        // This becomes necessary if module scan results are NOT uploaded with the version found in
        // the POM,
