...
public class MvnPluginReport extends AbstractVulasMojo {
   ...
   *
   * <p>If the given {@link MavenProject} has the packaging type 'POM', applications corresponding
   * to all its sub-modules will be added to this set.
   *
   * <p>Depending on the configuration option {@link CoreConfiguration#REP_OVERRIDE_VER}, the
   * application version is either taken from the POM or from configuration setting {@link
