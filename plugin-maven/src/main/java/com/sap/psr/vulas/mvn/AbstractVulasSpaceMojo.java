...
/** Abstract AbstractVulasSpaceMojo class. */
public abstract class AbstractVulasSpaceMojo extends AbstractMojo {
  ...
  /**
   * All plugin configuration settings of the element <layeredConfiguration> are put in this {@link
   * Map}.
   */
  ...
  /**
   * This method, called by Maven, first invokes {@link AbstractVulasSpaceMojo#createGoal()} and
   * then {@link AbstractVulasSpaceMojo#executeGoal()}.
   *
