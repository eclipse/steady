...
public class StubServerSetup {
  ...
  protected void configureBackendServiceUrl(StubServer _ss) {
    ...
    VulasConfiguration.getGlobal()
        .setProperty(VulasConfiguration.getServiceUrlKey(Service.BACKEND), this.backendURL);
  ...
  public void setupMockServices(Application _a) {
    ...
    expect().statusCode(201).when().post("/backend" + PathBuilder.apps());
    ...
    expect().statusCode(201).when().post("/backend" + PathBuilder.goalExcecutions(null, null, _a));
