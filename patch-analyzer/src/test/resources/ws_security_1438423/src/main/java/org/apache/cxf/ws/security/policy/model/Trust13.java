...
public class Trust13 extends AbstractSecurityAssertion {
   ...
   */
  public void setRequireRequestSecurityTokenCollection(
      boolean requireRequestSecurityTokenCollection) {
  ...
  public void serialize(XMLStreamWriter writer) throws XMLStreamException {
    ...
    writer.writeStartElement(
        wspPrefix, SPConstants.POLICY.getLocalPart(), SPConstants.POLICY.getNamespaceURI());
    ...
    if (isRequireRequestSecurityTokenCollection()) {
      ...
      writer.writeStartElement(
          prefix, SPConstants.REQUIRE_REQUEST_SECURITY_TOKEN_COLLECTION, namespaceURI);
      writer.writeEndElement();
    }
