...
public class SecurityTokenServiceProvider implements Provider<Source> {
  ...
  private static final String WSTRUST_13_NAMESPACE =
      "http://docs.oasis-open.org/ws-sx/ws-trust/200512";
  private static final String WSTRUST_REQUESTTYPE_ELEMENTNAME = "RequestType";
  private static final String WSTRUST_REQUESTTYPE_ISSUE = WSTRUST_13_NAMESPACE + "/Issue";
  private static final String WSTRUST_REQUESTTYPE_CANCEL = WSTRUST_13_NAMESPACE + "/Cancel";
  private static final String WSTRUST_REQUESTTYPE_RENEW = WSTRUST_13_NAMESPACE + "/Renew";
  private static final String WSTRUST_REQUESTTYPE_VALIDATE = WSTRUST_13_NAMESPACE + "/Validate";
  private static final String WSTRUST_REQUESTTYPE_REQUESTCOLLECTION =
      WSTRUST_13_NAMESPACE + "/RequestCollection";
  private static final String WSTRUST_REQUESTTYPE_KEYEXCHANGETOKEN =
      WSTRUST_13_NAMESPACE + "/KeyExchangeToken";
  ...
  static {
    try {
      Method m =
          IssueOperation.class.getDeclaredMethod(
              "issue", RequestSecurityTokenType.class, WebServiceContext.class);
      OPERATION_METHODS.put(WSTRUST_REQUESTTYPE_ISSUE, m);

      m =
          CancelOperation.class.getDeclaredMethod(
              "cancel", RequestSecurityTokenType.class, WebServiceContext.class);
      OPERATION_METHODS.put(WSTRUST_REQUESTTYPE_CANCEL, m);

      m =
          RenewOperation.class.getDeclaredMethod(
              "renew", RequestSecurityTokenType.class, WebServiceContext.class);
      OPERATION_METHODS.put(WSTRUST_REQUESTTYPE_RENEW, m);

      m =
          ValidateOperation.class.getDeclaredMethod(
              "validate", RequestSecurityTokenType.class, WebServiceContext.class);
      OPERATION_METHODS.put(WSTRUST_REQUESTTYPE_VALIDATE, m);

      m =
          KeyExchangeTokenOperation.class.getDeclaredMethod(
              "keyExchangeToken", RequestSecurityTokenType.class, WebServiceContext.class);
      OPERATION_METHODS.put(WSTRUST_REQUESTTYPE_KEYEXCHANGETOKEN, m);

      m =
          RequestCollectionOperation.class.getDeclaredMethod(
              "requestCollection",
  ...
  /**
   * Setting an IssueSingleOperation instance will override the default behaviour of issuing a token
   * in a RequestSecurityTokenResponseCollection
   */
  public void setIssueSingleOperation(IssueSingleOperation issueSingleOperation) {
    ...
    try {
      m =
          IssueSingleOperation.class.getDeclaredMethod(
              "issueSingle", RequestSecurityTokenType.class, WebServiceContext.class);
      OPERATION_METHODS.put(WSTRUST_REQUESTTYPE_ISSUE, m);
  ...
  public void setKeyExchangeTokenOperation(KeyExchangeTokenOperation keyExchangeTokenOperation) {
    ...
    operationMap.put(WSTRUST_REQUESTTYPE_KEYEXCHANGETOKEN, keyExchangeTokenOperation);
  }
  ...
  public void setRequestCollectionOperation(RequestCollectionOperation requestCollectionOperation) {
    ...
    operationMap.put(WSTRUST_REQUESTTYPE_REQUESTCOLLECTION, requestCollectionOperation);
  }
  ...
  public Source invoke(Source request) {
    ...
    try {
      ...
      if (obj instanceof RequestSecurityTokenResponseCollectionType) {
        ...
        response =
            new JAXBSource(
                jaxbContext, new ObjectFactory().createRequestSecurityTokenResponse(tokenResponse));
      }
      ...
      if (o == null && parent != null) {
        ...
        if (f.getAnnotation(XmlAnyElement.class) != null) {
          ...
          if (old instanceof Element
              && DOMUtils.getElementQName(element)
                  .equals(DOMUtils.getElementQName((Element) old))) {
