 ...
 * overrides the signature verification, so that if the signature is not trusted, it just sets a
 * boolean. The STSTokenValidator can parse this tag and dispatch the Assertion to the STS for
 * validation.
 */
public class STSSamlAssertionValidator extends SamlAssertionValidator {
  ...
  /**
   * Validate the credential argument. It must contain a non-null AssertionWrapper. A Crypto and a
