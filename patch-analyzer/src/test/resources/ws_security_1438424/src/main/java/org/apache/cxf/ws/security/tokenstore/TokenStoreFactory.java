...
/**
 * An abstract factory to return a TokenStore instance. It returns an EHCacheTokenStoreFactory if
 * EH-Cache is available. Otherwise it returns a MemoryTokenStoreFactory.
 */
