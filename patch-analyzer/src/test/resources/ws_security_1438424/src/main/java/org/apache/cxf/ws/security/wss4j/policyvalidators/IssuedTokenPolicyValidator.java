...
/**
 * Validate a WSSecurityEngineResult corresponding to the processing of a SAML Assertion or Kerberos
 * token against an IssuedToken policy.
 */
      ...
      if ("TokenType".equals(child.getLocalName())) {
        ...
        if (content.endsWith("SymmetricKey")) {
          ...
          if (subjectKeyInfo == null
              || (subjectKeyInfo.getPublicKey() == null && subjectKeyInfo.getCerts() == null)) {
            return false;
          }
        }
