...
public class Trust10Builder implements AssertionBuilder<Element> {
  ...
  public Assertion build(Element element, AssertionBuilderFactory factory)
    ...
    if (DOMUtils.getFirstChildWithName(element, SP11Constants.MUST_SUPPORT_CLIENT_CHALLENGE)
        != null) {
      trust10.setMustSupportClientChallenge(true);
    }

    if (DOMUtils.getFirstChildWithName(element, SP11Constants.MUST_SUPPORT_SERVER_CHALLENGE)
        != null) {
