...
public class AsymmetricBindingPolicyValidator extends AbstractBindingPolicyValidator {
  ...
  private boolean checkTokens(
    ...
    if (binding.getInitiatorToken() != null) {
      result &=
          checkInitiatorTokens(
              binding.getInitiatorToken(),
              binding,
              ai,
              aim,
              hasDerivedKeys,
    ...
    if (binding.getInitiatorSignatureToken() != null) {
      result &=
          checkInitiatorTokens(
              binding.getInitiatorSignatureToken(),
              binding,
              ai,
              aim,
              hasDerivedKeys,
    ...
    if (binding.getInitiatorEncryptionToken() != null) {
      result &=
          checkInitiatorTokens(
              binding.getInitiatorEncryptionToken(),
              binding,
              ai,
              aim,
              hasDerivedKeys,
    ...
    if (binding.getRecipientToken() != null) {
      result &=
          checkRecipientTokens(
              binding.getRecipientToken(),
              binding,
              ai,
              aim,
              hasDerivedKeys,
    ...
    if (binding.getRecipientSignatureToken() != null) {
      result &=
          checkRecipientTokens(
              binding.getRecipientSignatureToken(),
              binding,
              ai,
              aim,
              hasDerivedKeys,
    ...
    if (binding.getRecipientEncryptionToken() != null) {
      result &=
          checkRecipientTokens(
              binding.getRecipientEncryptionToken(),
              binding,
              ai,
              aim,
              hasDerivedKeys,
