...
/**
 * A RuntimeException that can be thrown by an STS implementation. If the FaultCode is set, then
 * this code/String will be returned to the user, otherwise the Exception message is returned.
 */
public class STSException extends RuntimeException {
  ...
  public static final QName AUTH_BAD_ELEMENTS =
      new QName(WST_NS_05_12, "AuthenticationBadElements");
