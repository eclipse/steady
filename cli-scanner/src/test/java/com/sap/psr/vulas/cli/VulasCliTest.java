...
public class VulasCliTest extends AbstractGoalTest {
    ...
    public void testCleanGoal() throws GoalConfigurationException, GoalExecutionException {
        ...
        verifyHttp(server)
                .times(1, method(Method.POST), uri("/backend" + PathBuilder.app(testApp)));
        verifyHttp(server)
                .times(
                        2,
                        method(Method.POST),
    ...
    public void testAppGoal() throws GoalConfigurationException, GoalExecutionException {
        ...
        final Path rel_app_with_space =
                Paths.get("src", "test", "resources", "appfolder with space");
        ...
        final Path rel_dep_with_space =
                Paths.get("src", "test", "resources", "depfolder with space");
