 ...
 * Mandatory configuration parameters such as the backend URL or the workspace token have to be
 * specified as system properties (-D) or using a configuration file "vulas-&lt;foo&gt;.properties".
 */
