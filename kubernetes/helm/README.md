[![](https://img.shields.io/badge/CoreChartScore-87-green.svg)](https://shields.io/)
[![](https://img.shields.io/badge/MonitoringChartScore-93-green.svg)](https://shields.io/)
[![](https://img.shields.io/badge/AdminChartScore-91-green.svg)](https://shields.io/)
[![Generic badge](https://img.shields.io/badge/version-0.1.0-blue.svg)](https://shields.io/)
# Vulas deployment to k8s

This readme is meant to give an overall view of the vulas deployment to kubernetes and does not go into detail about helm chart values.
...
This chart is an umbrella chart comprising of three main subcharts which are meant to be installed independently from each other:
- **vulas-core**: which encapsulates all the core components of vulas including
...
- **vulas-admin**: which encapsulates all the cluster admin tools
  - *nginx-ingress*: NGINX ingress controller used to expose the service


- **vulas-monitoring**: which is used to deploy vulas monitoring stack
...
![](docs/media/overall_architecture.png)

# Vulnerability-assessment-tool Core
This chart comprises of 6 subcharts and represents vulas's core architecture.
...
The database storing all data related to the vulnerability-assessment-tool. For high availability as well as performance, this chart implements a master-slave replication cluster for postgres. The replication method (see ![docs](https://www.postgresql.org/docs/current/high-availability.html)) can be summed up by the graph below:

![](docs/media/postgres.png)
